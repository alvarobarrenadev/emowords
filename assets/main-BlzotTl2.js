...
`);if(o.length<2)throw new Error("El archivo CSV debe tener al menos una fila de encabezados y una de datos");const a=xe(o[0]).map(s=>s.toLowerCase().trim()),t=a.findIndex(s=>s==="word"||s==="palabra"||s==="english"),i=a.findIndex(s=>s==="meaning"||s==="significado"||s==="spanish"||s==="traduccion"||s==="traducción");if(t===-1||i===-1)throw new Error('El CSV debe tener columnas "word" y "meaning" (o "palabra" y "significado")');const n=a.findIndex(s=>s==="type"||s==="tipo"),r=a.findIndex(s=>s==="category"||s==="categoria"||s==="categoría"),p=a.findIndex(s=>s==="example"||s==="ejemplo"),c=a.findIndex(s=>s==="emotion"||s==="emocion"||s==="emoción"||s==="association"||s==="asociacion"),h=P(),l=new Set(h.map(s=>s.word.toLowerCase().trim()));let b=0,k=0,g=0;for(let s=1;s<o.length;s++){const T=o[s].trim();if(!T)continue;const L=xe(T),A=L[t]?.trim(),M=L[i]?.trim();if(!A||!M){k++;continue}if(l.has(A.toLowerCase())){g++;continue}let I="word";if(n!==-1&&L[n]){const $=L[n].toLowerCase().trim();["phrasal","phrasal verb","phrasal-verb"].includes($)?I="phrasal":["expression","expresion","expresión"].includes($)?I="expression":["connector","conector"].includes($)?I="connector":["word","palabra"].includes($)&&(I="word")}const D={id:Date.now()+Math.random(),word:A,meaning:M,type:I,category:r!==-1&&L[r]?.trim()||null,example:p!==-1&&L[p]?.trim()||"",emotion:c!==-1&&L[c]?.trim()||"",image:"",remembered:!1,createdAt:Date.now(),lastReviewedAt:null,reviewCount:0,correctCount:0,incorrectCount:0,nextReviewAt:Date.now(),difficulty:0};h.push(D),l.add(A.toLowerCase()),b++}return localStorage.setItem(Z,JSON.stringify(h)),{success:!0,imported:b,skipped:k,duplicates:g}}catch(o){return{success:!1,error:o.message}}}function xe(e){const o=[];let a="",t=!1;for(let i=0;i<e.length;i++){const n=e[i];n==='"'?t=!t:(n===","||n===";")&&!t?(o.push(a.trim()),a=""):a+=n}return o.push(a.trim()),o}function Ae(e,o=null){const a=P(),t=e.toLowerCase().trim();return a.some(i=>i.word.toLowerCase().trim()===t&&i.id!==o)}function oe(){const e=localStorage.getItem(Ce);return e?JSON.parse(e):{theme:null,language:"es",showExampleInReview:!0,autoPlayAudio:!1}}function $e(e){localStorage.setItem(Ce,JSON.stringify(e))}const Pe="emowords_gamification";function de(){const e=localStorage.getItem(Pe);return e?JSON.parse(e):{streak:0,lastStudyDate:null,maxStreak:0,dailyGoal:{date:new Date().toLocaleDateString(),count:0,target:20},totalXp:0,level:1,perfectSessions:0,totalReviews:0}}function ye(e){localStorage.setItem(Pe,JSON.stringify(e))}function le(){const e=de(),o=new Date().toLocaleDateString();if(e.dailyGoal.date!==o){e.dailyGoal={date:o,count:0,target:e.dailyGoal.target||20};const a=new Date;a.setDate(a.getDate()-1),e.lastStudyDate!==a.toLocaleDateString()&&e.lastStudyDate!==o&&(e.streak>0,e.streak=0),ye(e)}return e}function Te(e=1,o={}){const a=de(),t=new Date().toLocaleDateString(),i=a.level;if(a.dailyGoal.date!==t&&(a.dailyGoal={date:t,count:0,target:a.dailyGoal.target||20}),a.dailyGoal.count+=e,a.totalReviews=(a.totalReviews||0)+e,o.perfectSession&&(a.perfectSessions=(a.perfectSessions||0)+1),a.lastStudyDate!==t){const r=new Date;r.setDate(r.getDate()-1);const p=r.toLocaleDateString();a.lastStudyDate===p?a.streak+=1:a.streak=1,a.streak>a.maxStreak&&(a.maxStreak=a.streak),a.lastStudyDate=t}a.totalXp+=e*10,a.level=Math.floor(Math.sqrt(a.totalXp/100))+1,ye(a);const n=a.level>i;return{...a,leveledUp:n,newLevel:n?a.level:null}}function na(e){const o=de();o.dailyGoal.target=e,ye(o)}function Y(e){const o=de();return{totalWords:e?.total||0,masteredWords:e?.mastered||0,wordsByType:e?.byType||{word:0,phrasal:0,expression:0,connector:0},maxStreak:o.maxStreak||0,streak:o.streak||0,totalReviews:o.totalReviews||0,perfectSessions:o.perfectSessions||0,level:o.level||1,studiedAtNight:!1,studiedEarly:!1}}const je="emowords_achievements",ae={first_word:{id:"first_word",name:"Primera Palabra",description:"Añade tu primera palabra",icon:"fa-seedling",category:"vocabulary",xpReward:10,condition:e=>e.totalWords>=1},collector_10:{id:"collector_10",name:"Coleccionista",description:"Alcanza 10 palabras en tu vocabulario",icon:"fa-layer-group",category:"vocabulary",xpReward:25,condition:e=>e.totalWords>=10},collector_50:{id:"collector_50",name:"Bibliotecario",description:"Alcanza 50 palabras en tu vocabulario",icon:"fa-book",category:"vocabulary",xpReward:50,condition:e=>e.totalWords>=50},collector_100:{id:"collector_100",name:"Erudito",description:"Alcanza 100 palabras en tu vocabulario",icon:"fa-graduation-cap",category:"vocabulary",xpReward:100,condition:e=>e.totalWords>=100},collector_500:{id:"collector_500",name:"Maestro del Léxico",description:"Alcanza 500 palabras en tu vocabulario",icon:"fa-crown",category:"vocabulary",xpReward:250,condition:e=>e.totalWords>=500},streak_3:{id:"streak_3",name:"En Racha",description:"Mantén una racha de 3 días",icon:"fa-fire",category:"streak",xpReward:30,condition:e=>e.maxStreak>=3},streak_7:{id:"streak_7",name:"Semana Perfecta",description:"Mantén una racha de 7 días",icon:"fa-fire-flame-curved",category:"streak",xpReward:70,condition:e=>e.maxStreak>=7},streak_30:{id:"streak_30",name:"Mes de Fuego",description:"Mantén una racha de 30 días",icon:"fa-meteor",category:"streak",xpReward:200,condition:e=>e.maxStreak>=30},streak_100:{id:"streak_100",name:"Imparable",description:"Mantén una racha de 100 días",icon:"fa-dragon",category:"streak",xpReward:500,condition:e=>e.maxStreak>=100},first_review:{id:"first_review",name:"Primer Repaso",description:"Completa tu primera sesión de repaso",icon:"fa-play",category:"review",xpReward:15,condition:e=>e.totalReviews>=1},reviewer_50:{id:"reviewer_50",name:"Repasador",description:"Completa 50 repasos",icon:"fa-rotate",category:"review",xpReward:50,condition:e=>e.totalReviews>=50},reviewer_200:{id:"reviewer_200",name:"Experto en Repasos",description:"Completa 200 repasos",icon:"fa-brain",category:"review",xpReward:100,condition:e=>e.totalReviews>=200},perfect_session:{id:"perfect_session",name:"Sesión Perfecta",description:"Completa una sesión sin errores (mín. 5 palabras)",icon:"fa-star",category:"review",xpReward:40,condition:e=>e.perfectSessions>=1},first_master:{id:"first_master",name:"Primera Maestría",description:"Domina completamente tu primera palabra",icon:"fa-gem",category:"mastery",xpReward:30,condition:e=>e.masteredWords>=1},master_10:{id:"master_10",name:"Dominador",description:"Domina 10 palabras",icon:"fa-trophy",category:"mastery",xpReward:75,condition:e=>e.masteredWords>=10},master_50:{id:"master_50",name:"Gran Maestro",description:"Domina 50 palabras",icon:"fa-medal",category:"mastery",xpReward:200,condition:e=>e.masteredWords>=50},level_5:{id:"level_5",name:"Aprendiz Dedicado",description:"Alcanza el nivel 5",icon:"fa-arrow-up",category:"level",xpReward:50,condition:e=>e.level>=5},level_10:{id:"level_10",name:"Estudiante Avanzado",description:"Alcanza el nivel 10",icon:"fa-ranking-star",category:"level",xpReward:100,condition:e=>e.level>=10},level_25:{id:"level_25",name:"Leyenda del Vocabulario",description:"Alcanza el nivel 25",icon:"fa-chess-king",category:"level",xpReward:300,condition:e=>e.level>=25},variety_master:{id:"variety_master",name:"Variedad",description:"Tiene al menos 5 de cada tipo (palabra, phrasal, expresión, conector)",icon:"fa-shapes",category:"special",xpReward:60,condition:e=>e.wordsByType.word>=5&&e.wordsByType.phrasal>=5&&e.wordsByType.expression>=5&&e.wordsByType.connector>=5},night_owl:{id:"night_owl",name:"Búho Nocturno",description:"Estudia después de medianoche",icon:"fa-moon",category:"special",xpReward:20,condition:e=>e.studiedAtNight},early_bird:{id:"early_bird",name:"Madrugador",description:"Estudia antes de las 7am",icon:"fa-sun",category:"special",xpReward:20,condition:e=>e.studiedEarly}};function pe(){const e=localStorage.getItem(je);return e?JSON.parse(e):[]}function Re(e){localStorage.setItem(je,JSON.stringify(e))}function K(e){const o=pe(),a=[];return Object.values(ae).forEach(t=>{o.includes(t.id)||t.condition(e)&&(o.push(t.id),a.push(t))}),a.length>0&&Re(o),a}function ze(){const e=pe();return Object.values(ae).map(o=>({...o,unlocked:e.includes(o.id)}))}function Me(){const e=Object.keys(ae).length,o=pe().length;return{total:e,unlocked:o,percent:Math.round(o/e*100)}}function ra(){const e=new Date().getHours(),o={studiedAtNight:e>=0&&e<5,studiedEarly:e>=5&&e<7},a=pe(),t=[];return o.studiedAtNight&&!a.includes("night_owl")&&(a.push("night_owl"),t.push(ae.night_owl)),o.studiedEarly&&!a.includes("early_bird")&&(a.push("early_bird"),t.push(ae.early_bird)),t.length>0&&Re(a),t}const ke="toast-container";function sa(){let e=document.getElementById(ke);return e||(e=document.createElement("div"),e.id=ke,e.className="toast-container",document.body.appendChild(e)),e}function C(e,o,a="info",t=4e3){const i=sa(),n=document.createElement("div"),r={info:"fa-circle-info",success:"fa-circle-check",warning:"fa-triangle-exclamation",error:"fa-circle-xmark"};n.className=`toast ${a}`,n.innerHTML=`
  ...
  `,a.querySelector(".speak-btn").addEventListener("click",c=>{c.stopPropagation(),O(e.word)}),a.querySelector(".toggle").addEventListener("click",()=>{e.remembered=!e.remembered,ge(e),o()}),a.querySelector(".delete").addEventListener("click",()=>{confirm(`¿Eliminar "${e.word}"?`)&&(Ye(e.id),o())}),a.querySelector(".edit-btn").addEventListener("click",()=>{va(e,o)}),a}function va(e,o){document.querySelector(".edit-modal")?.remove();const a=document.createElement("div");a.className="edit-modal",a.innerHTML=`
  ...
  `;const h=document.getElementById("word-list"),l=document.getElementById("filter-mastery"),b=document.getElementById("filter-type"),k=document.getElementById("filter-category"),g=document.getElementById("sort-by"),s=document.getElementById("search-input"),T=document.getElementById("clear-search"),L=document.getElementById("results-info"),A=document.getElementById("export-btn"),M=document.getElementById("import-btn"),I=document.getElementById("add-packs-btn"),D=document.getElementById("import-file");function $(){h.innerHTML="";let m=s.value.trim()?Xe(s.value.trim()):P();const E=Date.now();m=m.filter(d=>{let u=!0;l.value!=="all"&&(l.value==="due"?u=!d.nextReviewAt||d.nextReviewAt<=E:u=Se(d)===l.value);const w=b.value==="all"||d.type===b.value,v=k.value==="all"||d.category===k.value;return u&&w&&v}),m=Je(m,g.value);const x=P().length;if(s.value.trim()?(L.innerHTML=`<span class="results-count">${m.length} resultados</span> para "<strong>${s.value}</strong>"`,L.style.display="block"):m.length!==x?(L.innerHTML=`<span class="results-count">${m.length} de ${x}</span> palabras`,L.style.display="block"):L.style.display="none",m.length===0){h.innerHTML=`
      ...
      `;const d=h.querySelector("#import-packs-btn");if(d){let u=new Set;const w=()=>{const v=u.size;if(d.disabled=v===0,v===0)d.textContent="Selecciona packs",d.classList.remove("active");else{let q=0;u.forEach(j=>{const R=V.find(te=>te.id===j);R&&(q+=R.words.length)}),d.innerHTML=`<i class="fa-solid fa-download"></i> Añadir ${v} pack${v>1?"s":""} (${q} palabras)`,d.classList.add("active")}};h.querySelectorAll(".pack-card").forEach(v=>{v.addEventListener("click",()=>{const q=v.dataset.packId;u.has(q)?(u.delete(q),v.classList.remove("selected")):(u.add(q),v.classList.add("selected")),w()})}),d.addEventListener("click",()=>{if(u.size!==0&&confirm(`¿Añadir ${u.size} packs a tu vocabulario?`)){let v=[];u.forEach(R=>{const te=V.find(Fe=>Fe.id===R);te&&(v=v.concat(te.words))});const q=JSON.stringify({words:v}),j=se(q);if(j.success){C("Packs añadidos",`¡Genial! Se han añadido ${j.imported} palabras nuevas.`,"success");const R=K(Y(B()));R.length>0&&X(R),ue(e)}else C("Error","Hubo un problema al cargar los packs.","error")}})}}else m.forEach(d=>{h.appendChild(ya(d,$))})}l.addEventListener("change",$),b.addEventListener("change",$),k.addEventListener("change",$),g.addEventListener("change",$);let J;s.addEventListener("input",()=>{T.style.display=s.value?"flex":"none",clearTimeout(J),J=setTimeout($,300)}),T.addEventListener("click",()=>{s.value="",T.style.display="none",$()}),A.addEventListener("click",()=>{const m=ta(),E=new Blob([m],{type:"application/json"}),x=URL.createObjectURL(E),d=document.createElement("a");d.href=x,d.download=`emowords-backup-${new Date().toISOString().split("T")[0]}.json`,d.click(),URL.revokeObjectURL(x)}),I&&I.addEventListener("click",()=>{f()}),M.addEventListener("click",()=>{D.click()}),D.addEventListener("change",m=>{const E=m.target.files[0];if(!E)return;const x=E.name.toLowerCase().endsWith(".csv"),d=new FileReader;d.onload=u=>{const w=u.target.result;let v;if(x)if(v=ia(w),v.success){let q=`${v.imported} palabras importadas.`;v.duplicates>0&&(q+=` ${v.duplicates} duplicadas omitidas.`),v.skipped>0&&(q+=` ${v.skipped} con errores.`),C("Importación CSV completada",q,"success");const j=K(Y(B()));j.length>0&&X(j),setTimeout(()=>location.reload(),1500)}else C("Error de importación CSV",v.error,"error");else if(v=se(w),v.success){C("Importación completada",`${v.imported} palabras importadas.`,"success");const q=K(Y(B()));q.length>0&&X(q),setTimeout(()=>location.reload(),1500)}else C("Error de importación",v.error,"error")},d.readAsText(E),m.target.value=""});const N=document.getElementById("goal-settings-btn");N&&N.addEventListener("click",()=>{y()});const H=document.getElementById("explore-packs-btn");H&&H.addEventListener("click",()=>{f()});function f(){document.querySelector(".packs-modal")?.remove();let m=new Set;const E=document.createElement("div");E.className="packs-modal edit-modal",E.innerHTML=`
      <div class="modal-overlay"></div>
    ...
    `,document.body.appendChild(x),requestAnimationFrame(()=>{x.classList.add("active")});const d=()=>{x.classList.remove("active"),setTimeout(()=>x.remove(),300)};x.querySelector(".modal-overlay").addEventListener("click",d),x.querySelector(".modal-close").addEventListener("click",d),x.querySelector(".btn-cancel").addEventListener("click",d),x.querySelectorAll(".goal-option").forEach(u=>{u.addEventListener("click",()=>{const w=parseInt(u.dataset.value);na(w),C("Meta actualizada",`Tu nueva meta diaria es ${w} palabras.`,"success"),d(),ue(e)})}),document.addEventListener("keydown",function u(w){w.key==="Escape"&&(d(),document.removeEventListener("keydown",u))})}$()}function ha(e){return 100*Math.pow(e,2)}function ba(e,o){const a=100*Math.pow(o-1,2),i=100*Math.pow(o,2)-a,n=e-a;return Math.min(100,Math.max(0,n/i*100))}function wa(e,o){return e>=o?"¡Objetivo completado!":e>=o*.75?"¡Casi lo tienes!":e>=o*.5?"¡Ya vas por la mitad!":"¡Vamos a por ello!"}function xa(e){const o=Ie();e.innerHTML=`
...
Ejemplo: Mi coche se averió en la autopista y tuve que esperar 2 horas bajo la lluvia..."></textarea>
  ...
  `;const a=document.getElementById("add-word-form"),t=document.getElementById("image-preview"),i=document.getElementById("preview-img"),n=document.getElementById("remove-preview"),r=document.getElementById("clear-form"),p=document.getElementById("image-data"),c=document.querySelectorAll(".image-tab"),h=document.querySelectorAll(".image-tab-content"),l=document.getElementById("upload-area"),b=document.getElementById("image-file"),k=document.getElementById("image-url"),g=document.getElementById("preview-url-btn");c.forEach(T=>{T.addEventListener("click",()=>{const L=T.dataset.tab;c.forEach(A=>A.classList.remove("active")),T.classList.add("active"),h.forEach(A=>{A.classList.remove("active"),A.id===`${L}-content`&&A.classList.add("active")})})}),l.addEventListener("click",()=>{b.click()}),l.addEventListener("dragover",T=>{T.preventDefault(),l.classList.add("dragover")}),l.addEventListener("dragleave",()=>{l.classList.remove("dragover")}),l.addEventListener("drop",T=>{T.preventDefault(),l.classList.remove("dragover");const L=T.dataTransfer.files;L.length>0&&s(L[0])}),b.addEventListener("change",T=>{T.target.files.length>0&&s(T.target.files[0])});function s(T){if(!T.type.startsWith("image/")){C("Archivo inválido","Por favor selecciona un archivo de imagen.","error");return}const L=2*1024*1024;if(T.size>L){C("Imagen muy grande","La imagen debe ser menor a 2MB.","error");return}const A=new FileReader;A.onload=M=>{const I=M.target.result;i.src=I,t.style.display="block",p.value=I,l.classList.add("has-file"),C("Imagen cargada","La imagen se ha cargado correctamente.","success")},A.onerror=()=>{C("Error","No se pudo leer la imagen.","error")},A.readAsDataURL(T)}g.addEventListener("click",()=>{const T=k.value.trim();T&&(i.src=T,t.style.display="block",p.value=T,i.onerror=()=>{t.style.display="none",p.value="",C("Error de imagen","No se pudo cargar la imagen. Verifica la URL.","warning")})}),k.addEventListener("keypress",T=>{T.key==="Enter"&&(T.preventDefault(),g.click())}),n.addEventListener("click",()=>{k.value="",b.value="",p.value="",t.style.display="none",i.src="",l.classList.remove("has-file")}),r.addEventListener("click",()=>{a.reset(),t.style.display="none",i.src="",p.value="",l.classList.remove("has-file")}),a.addEventListener("submit",T=>{T.preventDefault();const L=document.getElementById("word").value.trim(),A=document.getElementById("meaning").value.trim(),M=document.getElementById("type").value,I=document.getElementById("category").value.trim(),D=document.getElementById("emotion").value.trim(),$=document.getElementById("example").value.trim(),J=p.value.trim();if(!L||!A){C("Faltan datos","Por favor completa al menos la palabra y su significado.","error");return}if(Ae(L)){C("Palabra duplicada",`La palabra "${L}" ya existe en tu vocabulario.`,"error");return}const N={id:Date.now(),word:L,meaning:A,type:M,category:I||null,emotion:D,example:$,image:J,remembered:!1};Ue(N),a.reset(),t.style.display="none",i.src="",p.value="",l.classList.remove("has-file"),C("¡Guardado!",`"${L}" se ha añadido correctamente.`,"success");try{const H=B(),f=Y(H),y=K(f);y.length>0&&X(y)}catch(H){console.error("Error checking achievements:",H)}document.getElementById("word").focus()})}const Ta="modulepreload",ka=function(e){return"/emowords/"+e},qe={},Ea=function(o,a,t){let i=Promise.resolve();if(a&&a.length>0){let h=function(l){return Promise.all(l.map(b=>Promise.resolve(b).then(k=>({status:"fulfilled",value:k}),k=>({status:"rejected",reason:k}))))};var r=h;document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),c=p?.nonce||p?.getAttribute("nonce");i=h(a.map(l=>{if(l=ka(l),l in qe)return;qe[l]=!0;const b=l.endsWith(".css"),k=b?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${k}`))return;const g=document.createElement("link");if(g.rel=b?"stylesheet":Ta,b||(g.as="script"),g.crossOrigin="",g.href=l,c&&g.setAttribute("nonce",c),document.head.appendChild(g),b)return new Promise((s,T)=>{g.addEventListener("load",s),g.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(p){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=p,window.dispatchEvent(c),!c.defaultPrevented)throw p}return i.then(p=>{for(const c of p||[])c.status==="rejected"&&n(c.reason);return o().catch(n)})};function qa(e){let o=null,a=null,t=!1,i=[],n={correct:0,incorrect:0,xp:0},r=new Map;const p=2;i=we(),N(i);function c(){e.innerHTML="",o||h()}function h(){const f=we(),y={limit:"all",types:new Set(["word","phrasal","expression","connector"])},m={total:f.length,word:f.filter(d=>d.type==="word").length,phrasal:f.filter(d=>d.type==="phrasal").length,expression:f.filter(d=>d.type==="expression").length,connector:f.filter(d=>d.type==="connector").length};e.innerHTML=`
    ...
    `;const x=document.getElementById("listen-icon"),d=()=>{x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="scale(1)",150),O(a.word)};x.addEventListener("click",d),setTimeout(d,500);const u=f.querySelectorAll(".quiz-option");let w=!1;u.forEach(v=>{v.addEventListener("click",()=>{if(w)return;w=!0,String(v.dataset.id)===String(a.id)?(v.classList.add("correct"),setTimeout(()=>I(!0),800)):(v.classList.add("wrong"),u.forEach(R=>{String(R.dataset.id)===String(a.id)&&R.classList.add("correct")}),setTimeout(()=>I(!1),1500))})})}function I(f){try{if(!a)return;if(oa(a.id,f),f){n.correct++,n.xp+=10;try{Te(1)}catch(y){console.error(y)}r.delete(a.id)}else{n.incorrect++;const y=r.get(a.id)||0;y<p&&(r.set(a.id,y+1),i.push(a))}a=null,b(),s()}catch(y){console.error("Error in handleResult:",y)}}function D(f){try{const y=n.incorrect===0&&n.correct>=5,m=Te(0,{perfectSession:y}),E=document.querySelector(".review-header");E&&(E.style.display="none");let x;try{x=le()}catch{x={streak:0,dailyGoal:{count:0,target:20}}}const d=B(),u=Y(d),w=K(u);pa(),f.innerHTML=`
          <div class="empty-review-state">
    ...
    `:""}
  `;e.innerHTML=k,La(e)}function La(e){e.querySelectorAll(".collapse-btn").forEach(a=>{a.addEventListener("click",()=>{a.closest(".stats-card").classList.toggle("collapsed");const i=a.querySelector("i");i.classList.toggle("fa-chevron-up"),i.classList.toggle("fa-chevron-down")})});const o=e.querySelector("#view-all-achievements");o&&o.addEventListener("click",()=>{Ca()})}function Ca(){const e=ze(),o=Me(),a=document.createElement("div");a.className="achievements-modal animate__animated animate__fadeIn",a.innerHTML=`
  ...
  `;const o=e.querySelector("#explore-packs-stats-btn");o&&o.addEventListener("click",()=>{document.querySelector("[data-view=home]").click(),setTimeout(()=>{const a=document.getElementById("explore-packs-btn");a&&a.click()},100)})}function Sa(e){const o=[...e].sort((n,r)=>(n.createdAt||0)-(r.createdAt||0)),a=new Map;let t=0;o.forEach(n=>{t++;const r=new Date(n.createdAt||Date.now()).toISOString().split("T")[0];a.set(r,t)});const i=Array.from(a.entries()).map(([n,r])=>({date:n,count:r}));if(i.length>0&&i.length<2){const n=new Date(i[0].date);n.setDate(n.getDate()-1),i.unshift({date:n.toISOString().split("T")[0],count:0})}return i}function Aa(e){return[...e].filter(o=>(o.incorrectCount||0)>0).sort((o,a)=>(a.incorrectCount||0)-(o.incorrectCount||0)).slice(0,5)}function ie(e,o){return o?Math.round(e/o*100):0}function $a(e){return e>=90?"S":e>=80?"A":e>=60?"B":e>=40?"C":"D"}function Pa(e){return e>=90?"grade-s":e>=80?"grade-a":e>=60?"grade-b":e>=40?"grade-c":"grade-d"}function ja(e,o){const a=e.length;if(a<2||o.length<2)return null;const t=new Date(o[0].date),i=new Date(o[o.length-1].date),n=Math.max(1,Math.ceil((i-t)/(1440*60*1e3))),r=a/n;return a<500?`A este ritmo alcanzarás <strong>500 palabras</strong> en ~${Math.ceil((500-a)/r)} días`:a<1e3?`A este ritmo alcanzarás <strong>1000 palabras</strong> en ~${Math.ceil((1e3-a)/r)} días`:`¡Increíble! Ya dominas <strong>${a}</strong> palabras 🎉`}function Ra(e){if(!e||e.length===0)return'<div class="chart-placeholder">Sin datos suficientes</div>';const o=600,a=200,t=30,i=e[e.length-1].count;if(i===0)return"";const n=e.map((h,l)=>{const b=l/(e.length-1)*(o-2*t)+t,k=a-(h.count/i*(a-2*t)+t);return`${b},${k}`}).join(" "),r=t,p=o-t,c=`${r},${a-t} ${n} ${p},${a-t}`;return`
  ...
  `;e.innerHTML=t,Wa(e,o)}function Ba(e,o){const a=e.checkUnlocked(o),t=De(e,o);return`
  ...
  `,o.type==="pack-selection"&&U){let l=[];U==="A1-A2"?l=V.filter(s=>s.level==="A1"||s.level==="A2"):U==="C1-C2"?l=V.filter(s=>s.level==="C1"||s.level==="C2"):l=V.filter(s=>s.level===U);const b=`
    ...
    `,k=document.createElement("div");k.innerHTML=S.innerHTML;const g=k.querySelector(".tooltip-body");g&&(g.insertAdjacentHTML("beforeend",b),S.innerHTML=k.innerHTML)}if(W.appendChild(S),o.position==="center"||!o.target)S.classList.add("centered"),He();else{S.classList.remove("centered");const l=document.querySelector(o.target);l?Ja(l,o.position):(S.classList.add("centered"),G.style.display="none")}const p=S.querySelector(".tooltip-skip"),c=S.querySelector(".tooltip-next"),h=S.querySelector(".tooltip-prev");if(p.addEventListener("click",eo),c.addEventListener("click",Qa),h&&h.addEventListener("click",Za),i){const l=S.querySelectorAll(".level-btn");l.forEach(b=>{b.addEventListener("click",()=>{l.forEach(k=>k.classList.remove("active")),b.classList.add("active"),U=b.dataset.level,localStorage.setItem(Be,U),c.removeAttribute("disabled")})})}o.type==="pack-selection"&&S.querySelectorAll(".pack-card-mini").forEach(b=>{b.addEventListener("click",()=>{const k=b.dataset.packId,s=b.querySelector(".pack-add-btn").querySelector("i"),T=V.find(L=>L.id===k);b.classList.contains("added")?C("Pack ya añadido","Este pack ya está en tu colección","info"):T&&se(JSON.stringify({words:T.words})).success&&(b.classList.add("added"),s.classList.remove("fa-plus"),s.classList.add("fa-check"),localStorage.setItem("pack_"+k,"true"),C("Pack añadido",`Has añadido ${T.name} a tu colección`,"success"))})}),requestAnimationFrame(()=>{S.classList.add("visible")})}function Ja(e,o){const a=e.getBoundingClientRect(),t=8,i=16;G.style.top=`${a.top-t}px`,G.style.left=`${a.left-t}px`,G.style.width=`${a.width+t*2}px`,G.style.height=`${a.height+t*2}px`;const n=S.getBoundingClientRect();let r,p;switch(o){case"bottom":r=a.bottom+i,p=a.left+a.width/2-n.width/2;break;case"top":r=a.top-i-n.height,p=a.left+a.width/2-n.width/2;break;case"left":r=a.top+a.height/2-n.height/2,p=a.left-i-n.width;break;case"right":r=a.top+a.height/2-n.height/2,p=a.right+i;break;default:r=a.bottom+i,p=a.left+a.width/2-n.width/2}const c=window.innerWidth,h=window.innerHeight;p<16&&(p=16),p+n.width>c-16&&(p=c-n.width-16),r<16&&(r=16),r+n.height>h-16&&(r=h-n.height-16),S.style.position="fixed",S.style.top=`${r}px`,S.style.left=`${p}px`}function He(){document.querySelectorAll(".onboarding-highlight").forEach(e=>{e.classList.remove("onboarding-highlight")})}function Qa(){_++,fe(_)}function Za(){_--,_<0&&(_=0),fe(_)}function eo(){Oe()}function Oe(){Ya(),S&&(S.classList.remove("visible"),setTimeout(()=>S?.remove(),200)),W&&(W.classList.add("fade-out"),setTimeout(()=>W?.remove(),300)),He(),window.dispatchEvent(new CustomEvent("onboardingCompleted"))}const z=document.getElementById("app");window.addEventListener("offline",()=>{C("Sin conexión","Estás trabajando en modo offline.","warning",5e3),document.body.classList.add("offline-mode")});window.addEventListener("online",()=>{C("Conexión restaurada","Tus cambios se guardarán correctamente.","success",3e3),document.body.classList.remove("offline-mode")});window.addEventListener("error",e=>{console.error("Global error:",e.error),C("Error inesperado","Ha ocurrido un error. Intenta recargar la página.","error",0)});window.addEventListener("unhandledrejection",e=>{console.error("Unhandled promise rejection:",e.reason)});const _e=document.querySelectorAll(".nav-link"),Q=document.getElementById("theme-toggle");function ao(){const e=oe();if(e.theme)ce(e.theme);else{const o=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";ce(o)}}function ce(e){if(document.documentElement.setAttribute("data-theme",e),Q){const o=Q.querySelector("i");o&&(e==="dark"?(o.className="fa-solid fa-sun",Q.title="Cambiar a modo claro"):(o.className="fa-solid fa-moon",Q.title="Cambiar a modo oscuro"))}}function oo(){const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.body.classList.add("theme-transitioning"),ce(o);const a=oe();a.theme=o,$e(a),setTimeout(()=>{document.body.classList.remove("theme-transitioning")},300)}Q&&Q.addEventListener("click",oo);window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",e=>{oe().theme||ce(e.matches?"dark":"light")});function Ge(){const e=document.getElementById("review-badge");if(!e)return;const o=ea();o>0?(e.textContent=o>99?"99+":o,e.style.display="flex"):e.style.display="none"}function to(e){_e.forEach(o=>{o.dataset.view===e?o.classList.add("active"):o.classList.remove("active")})}function me(e){window._reviewCleanup&&(window._reviewCleanup(),window._reviewCleanup=null),to(e),z.style.opacity="0",z.style.transform="translateY(10px)",setTimeout(()=>{switch(e){case"home":ue(z);break;case"add":xa(z);break;case"review":qa(z);break;case"stats":Ve(z);break;case"coaches":Na(z);break;case"settings":Oa(z);break;default:z.innerHTML="<p>Vista no encontrada</p>"}window.scrollTo({top:0,left:0,behavior:"instant"}),requestAnimationFrame(()=>{z.style.opacity="1",z.style.transform="translateY(0)"}),Ge()},150)}z.style.transition="opacity 0.15s ease, transform 0.15s ease";_e.forEach(e=>{e.addEventListener("click",o=>{o.preventDefault();const a=e.dataset.view;me(a)})});const re=document.querySelector(".logo");re&&re.dataset.view&&re.addEventListener("click",e=>{e.preventDefault(),me(re.dataset.view)});ao();Ge();me("home");setTimeout(()=>{We()&&Ka()},500);window.addEventListener("onboardingCompleted",()=>{me("home")});"serviceWorker"in navigator&&window.addEventListener("load",()=>{const o="/emowords/"+"sw.js";navigator.serviceWorker.register(o).then(a=>{console.log("SW registered: ",a)}).catch(a=>{console.log("SW registration failed: ",a)})});
