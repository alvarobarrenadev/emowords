(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const H="emowords_vocab",ye="emowords_settings";function T(){const e=localStorage.getItem(H);return e?JSON.parse(e):[]}function Ce(e){const t=T(),a={...e,createdAt:Date.now(),lastReviewedAt:null,reviewCount:0,correctCount:0,incorrectCount:0,nextReviewAt:Date.now(),difficulty:0};t.push(a),localStorage.setItem(H,JSON.stringify(t))}function ae(e){const t=T().map(a=>a.id===e.id?e:a);localStorage.setItem(H,JSON.stringify(t))}function Ae(e){const t=T().filter(a=>a.id!==e);localStorage.setItem(H,JSON.stringify(t))}function $e(e){return T().find(t=>t.id===e)}function Te(e){const t=T(),a=e.toLowerCase().trim();return a?t.filter(o=>o.word.toLowerCase().includes(a)||o.meaning.toLowerCase().includes(a)||o.example&&o.example.toLowerCase().includes(a)||o.emotion&&o.emotion.toLowerCase().includes(a)||o.category&&o.category.toLowerCase().includes(a)):t}function ve(){const e=T(),t=new Set;return e.forEach(a=>{a.category&&t.add(a.category)}),Array.from(t).sort()}function Pe(e,t="date-desc"){const a=[...e];switch(t){case"date-asc":return a.sort((o,n)=>(o.createdAt||o.id)-(n.createdAt||n.id));case"date-desc":return a.sort((o,n)=>(n.createdAt||n.id)-(o.createdAt||o.id));case"alpha-asc":return a.sort((o,n)=>o.word.localeCompare(n.word));case"alpha-desc":return a.sort((o,n)=>n.word.localeCompare(o.word));case"review-count":return a.sort((o,n)=>(n.reviewCount||0)-(o.reviewCount||0));case"difficulty":return a.sort((o,n)=>(n.difficulty||0)-(o.difficulty||0));default:return a}}function te(){const e=T(),t=e.length,a=e.filter(w=>w.remembered).length,o=t-a,n=e.reduce((w,S)=>w+(S.reviewCount||0),0),s=t>0?(n/t).toFixed(1):0,r={word:e.filter(w=>w.type==="word").length,phrasal:e.filter(w=>w.type==="phrasal").length,expression:e.filter(w=>w.type==="expression").length,connector:e.filter(w=>w.type==="connector").length},u=e.reduce((w,S)=>w+(S.correctCount||0),0),c=e.reduce((w,S)=>w+(S.incorrectCount||0),0),y=u+c>0?(u/(u+c)*100).toFixed(1):0,l=Date.now(),E=e.filter(w=>!w.nextReviewAt||w.nextReviewAt<=l).length;return{total:t,remembered:a,forgotten:o,totalReviews:n,averageReviews:s,byType:r,retentionRate:y,dueForReview:E}}const ie=[1,3,7,14,30,60,120,240];function fe(e){const t=e.correctCount||0;return t>=10?"master":t>=5?"guru":t>=2?"apprentice":"new"}function Ve(e){const t=fe(e);return{level:t,...{new:{label:"Nuevo",class:"mastery-new",icon:"fa-seedling",percent:10},apprentice:{label:"Aprendiz",class:"mastery-apprentice",icon:"fa-leaf",percent:40},guru:{label:"Experto",class:"mastery-guru",icon:"fa-tree",percent:75},master:{label:"Maestro",class:"mastery-master",icon:"fa-crown",percent:100}}[t]}}function Me(e){if(!e.nextReviewAt)return!0;const t=new Date().setHours(23,59,59,999);return e.nextReviewAt<=t}function Be(){const e=T(),t=Date.now();return e.filter(a=>!a.nextReviewAt||a.nextReviewAt<=t).length}function le(e,t){const a=Date.now(),o=1440*60*1e3;if(!t)return a+600*1e3;const n=e.correctCount||0,s=Math.min(n,ie.length-1),r=ie[s],c=1-(e.difficulty||0)*.1,y=Math.max(1,Math.round(r*c));return a+y*o}function qe(e){if(!e.nextReviewAt)return"Ahora";const t=Date.now(),a=e.nextReviewAt-t;if(a<=0)return"Ahora";const o=Math.floor(a/(60*1e3)),n=Math.floor(a/(3600*1e3)),s=Math.floor(a/(1440*60*1e3));return o<60?`${o}min`:n<24?`${n}h`:s===1?"Mañana":s<7?`${s} días`:s<30?`${Math.floor(s/7)} sem`:`${Math.floor(s/30)} mes${Math.floor(s/30)>1?"es":""}`}function Re(){const e=T(),t=Date.now();return e.filter(o=>!o.nextReviewAt||o.nextReviewAt<=t).sort((o,n)=>{const s=t-(o.nextReviewAt||0),r=t-(n.nextReviewAt||0);if(s!==r)return r-s;const u=o.difficulty||0,c=n.difficulty||0;return u!==c?c-u:(o.reviewCount||0)-(n.reviewCount||0)})}function De(e,t){const a=$e(e);if(a)return a.remembered=t,a.lastReviewedAt=Date.now(),a.reviewCount=(a.reviewCount||0)+1,t?(a.correctCount=(a.correctCount||0)+1,a.difficulty=Math.max(-3,(a.difficulty||0)-1),a.nextReviewAt=le(a,!0)):(a.incorrectCount=(a.incorrectCount||0)+1,a.difficulty=Math.min(3,(a.difficulty||0)+1),a.correctCount=Math.max(0,(a.correctCount||0)-2),a.nextReviewAt=le(a,!1)),ae(a),a}function Ne(){const e=T(),t={version:"1.0",exportedAt:new Date().toISOString(),wordCount:e.length,words:e};return JSON.stringify(t,null,2)}function K(e){try{const t=JSON.parse(e);if(!t.words||!Array.isArray(t.words))throw new Error("Invalid data format: missing words array");const a=T(),o=new Set(a.map(r=>r.id));let n=0,s=0;return t.words.forEach(r=>{if(!r.word||!r.meaning){s++;return}(!r.id||o.has(r.id))&&(r.id=Date.now()+Math.random()),r.type=r.type||"word",r.remembered=r.remembered||!1,r.createdAt=r.createdAt||Date.now(),a.push(r),o.add(r.id),n++}),localStorage.setItem(H,JSON.stringify(a)),{success:!0,imported:n,skipped:s}}catch(t){return{success:!1,error:t.message}}}function We(e){try{const t=e.trim().split(`
`);if(t.length<2)throw new Error("El archivo CSV debe tener al menos una fila de encabezados y una de datos");const a=ce(t[0]).map(d=>d.toLowerCase().trim()),o=a.findIndex(d=>d==="word"||d==="palabra"||d==="english"),n=a.findIndex(d=>d==="meaning"||d==="significado"||d==="spanish"||d==="traduccion"||d==="traducción");if(o===-1||n===-1)throw new Error('El CSV debe tener columnas "word" y "meaning" (o "palabra" y "significado")');const s=a.findIndex(d=>d==="type"||d==="tipo"),r=a.findIndex(d=>d==="category"||d==="categoria"||d==="categoría"),u=a.findIndex(d=>d==="example"||d==="ejemplo"),c=a.findIndex(d=>d==="emotion"||d==="emocion"||d==="emoción"||d==="association"||d==="asociacion"),y=T(),l=new Set(y.map(d=>d.word.toLowerCase().trim()));let E=0,w=0,S=0;for(let d=1;d<t.length;d++){const x=t[d].trim();if(!x)continue;const I=ce(x),$=I[o]?.trim(),B=I[n]?.trim();if(!$||!B){w++;continue}if(l.has($.toLowerCase())){S++;continue}let C="word";if(s!==-1&&I[s]){const V=I[s].toLowerCase().trim();["phrasal","phrasal verb","phrasal-verb"].includes(V)?C="phrasal":["expression","expresion","expresión"].includes(V)?C="expression":["connector","conector"].includes(V)?C="connector":["word","palabra"].includes(V)&&(C="word")}const P={id:Date.now()+Math.random(),word:$,meaning:B,type:C,category:r!==-1&&I[r]?.trim()||null,example:u!==-1&&I[u]?.trim()||"",emotion:c!==-1&&I[c]?.trim()||"",image:"",remembered:!1,createdAt:Date.now(),lastReviewedAt:null,reviewCount:0,correctCount:0,incorrectCount:0,nextReviewAt:Date.now(),difficulty:0};y.push(P),l.add($.toLowerCase()),E++}return localStorage.setItem(H,JSON.stringify(y)),{success:!0,imported:E,skipped:w,duplicates:S}}catch(t){return{success:!1,error:t.message}}}function ce(e){const t=[];let a="",o=!1;for(let n=0;n<e.length;n++){const s=e[n];s==='"'?o=!o:(s===","||s===";")&&!o?(t.push(a.trim()),a=""):a+=s}return t.push(a.trim()),t}function he(e,t=null){const a=T(),o=e.toLowerCase().trim();return a.some(n=>n.word.toLowerCase().trim()===o&&n.id!==t)}function j(){const e=localStorage.getItem(ye);return e?JSON.parse(e):{theme:"dark",language:"es",showExampleInReview:!0,autoPlayAudio:!1}}function we(e){localStorage.setItem(ye,JSON.stringify(e))}const be="emowords_gamification";function Y(){const e=localStorage.getItem(be);return e?JSON.parse(e):{streak:0,lastStudyDate:null,maxStreak:0,dailyGoal:{date:new Date().toLocaleDateString(),count:0,target:20},totalXp:0,level:1,perfectSessions:0,totalReviews:0}}function oe(e){localStorage.setItem(be,JSON.stringify(e))}function Q(){const e=Y(),t=new Date().toLocaleDateString();if(e.dailyGoal.date!==t){e.dailyGoal={date:t,count:0,target:e.dailyGoal.target||20};const a=new Date;a.setDate(a.getDate()-1),e.lastStudyDate!==a.toLocaleDateString()&&e.lastStudyDate!==t&&(e.streak>0,e.streak=0),oe(e)}return e}function de(e=1,t={}){const a=Y(),o=new Date().toLocaleDateString(),n=a.level;if(a.dailyGoal.date!==o&&(a.dailyGoal={date:o,count:0,target:a.dailyGoal.target||20}),a.dailyGoal.count+=e,a.totalReviews=(a.totalReviews||0)+e,t.perfectSession&&(a.perfectSessions=(a.perfectSessions||0)+1),a.lastStudyDate!==o){const r=new Date;r.setDate(r.getDate()-1);const u=r.toLocaleDateString();a.lastStudyDate===u?a.streak+=1:a.streak=1,a.streak>a.maxStreak&&(a.maxStreak=a.streak),a.lastStudyDate=o}a.totalXp+=e*10,a.level=Math.floor(Math.sqrt(a.totalXp/100))+1,oe(a);const s=a.level>n;return{...a,leveledUp:s,newLevel:s?a.level:null}}function ze(e){const t=Y();t.dailyGoal.target=e,oe(t)}function Ge(e){const t=Y();return{totalWords:e?.total||0,masteredWords:e?.mastered||0,wordsByType:e?.byType||{word:0,phrasal:0,expression:0,connector:0},maxStreak:t.maxStreak||0,streak:t.streak||0,totalReviews:t.totalReviews||0,perfectSessions:t.perfectSessions||0,level:t.level||1,studiedAtNight:!1,studiedEarly:!1}}const xe="emowords_achievements",_={first_word:{id:"first_word",name:"Primera Palabra",description:"Añade tu primera palabra",icon:"fa-seedling",category:"vocabulary",xpReward:10,condition:e=>e.totalWords>=1},collector_10:{id:"collector_10",name:"Coleccionista",description:"Alcanza 10 palabras en tu vocabulario",icon:"fa-layer-group",category:"vocabulary",xpReward:25,condition:e=>e.totalWords>=10},collector_50:{id:"collector_50",name:"Bibliotecario",description:"Alcanza 50 palabras en tu vocabulario",icon:"fa-book",category:"vocabulary",xpReward:50,condition:e=>e.totalWords>=50},collector_100:{id:"collector_100",name:"Erudito",description:"Alcanza 100 palabras en tu vocabulario",icon:"fa-graduation-cap",category:"vocabulary",xpReward:100,condition:e=>e.totalWords>=100},collector_500:{id:"collector_500",name:"Maestro del Léxico",description:"Alcanza 500 palabras en tu vocabulario",icon:"fa-crown",category:"vocabulary",xpReward:250,condition:e=>e.totalWords>=500},streak_3:{id:"streak_3",name:"En Racha",description:"Mantén una racha de 3 días",icon:"fa-fire",category:"streak",xpReward:30,condition:e=>e.maxStreak>=3},streak_7:{id:"streak_7",name:"Semana Perfecta",description:"Mantén una racha de 7 días",icon:"fa-fire-flame-curved",category:"streak",xpReward:70,condition:e=>e.maxStreak>=7},streak_30:{id:"streak_30",name:"Mes de Fuego",description:"Mantén una racha de 30 días",icon:"fa-meteor",category:"streak",xpReward:200,condition:e=>e.maxStreak>=30},streak_100:{id:"streak_100",name:"Imparable",description:"Mantén una racha de 100 días",icon:"fa-dragon",category:"streak",xpReward:500,condition:e=>e.maxStreak>=100},first_review:{id:"first_review",name:"Primer Repaso",description:"Completa tu primera sesión de repaso",icon:"fa-play",category:"review",xpReward:15,condition:e=>e.totalReviews>=1},reviewer_50:{id:"reviewer_50",name:"Repasador",description:"Completa 50 repasos",icon:"fa-rotate",category:"review",xpReward:50,condition:e=>e.totalReviews>=50},reviewer_200:{id:"reviewer_200",name:"Experto en Repasos",description:"Completa 200 repasos",icon:"fa-brain",category:"review",xpReward:100,condition:e=>e.totalReviews>=200},perfect_session:{id:"perfect_session",name:"Sesión Perfecta",description:"Completa una sesión sin errores (mín. 5 palabras)",icon:"fa-star",category:"review",xpReward:40,condition:e=>e.perfectSessions>=1},first_master:{id:"first_master",name:"Primera Maestría",description:"Domina completamente tu primera palabra",icon:"fa-gem",category:"mastery",xpReward:30,condition:e=>e.masteredWords>=1},master_10:{id:"master_10",name:"Dominador",description:"Domina 10 palabras",icon:"fa-trophy",category:"mastery",xpReward:75,condition:e=>e.masteredWords>=10},master_50:{id:"master_50",name:"Gran Maestro",description:"Domina 50 palabras",icon:"fa-medal",category:"mastery",xpReward:200,condition:e=>e.masteredWords>=50},level_5:{id:"level_5",name:"Aprendiz Dedicado",description:"Alcanza el nivel 5",icon:"fa-arrow-up",category:"level",xpReward:50,condition:e=>e.level>=5},level_10:{id:"level_10",name:"Estudiante Avanzado",description:"Alcanza el nivel 10",icon:"fa-ranking-star",category:"level",xpReward:100,condition:e=>e.level>=10},level_25:{id:"level_25",name:"Leyenda del Vocabulario",description:"Alcanza el nivel 25",icon:"fa-chess-king",category:"level",xpReward:300,condition:e=>e.level>=25},variety_master:{id:"variety_master",name:"Variedad",description:"Tiene al menos 5 de cada tipo (palabra, phrasal, expresión, conector)",icon:"fa-shapes",category:"special",xpReward:60,condition:e=>e.wordsByType.word>=5&&e.wordsByType.phrasal>=5&&e.wordsByType.expression>=5&&e.wordsByType.connector>=5},night_owl:{id:"night_owl",name:"Búho Nocturno",description:"Estudia después de medianoche",icon:"fa-moon",category:"special",xpReward:20,condition:e=>e.studiedAtNight},early_bird:{id:"early_bird",name:"Madrugador",description:"Estudia antes de las 7am",icon:"fa-sun",category:"special",xpReward:20,condition:e=>e.studiedEarly}};function X(){const e=localStorage.getItem(xe);return e?JSON.parse(e):[]}function ke(e){localStorage.setItem(xe,JSON.stringify(e))}function He(e){const t=X(),a=[];return Object.values(_).forEach(o=>{t.includes(o.id)||o.condition(e)&&(t.push(o.id),a.push(o))}),a.length>0&&ke(t),a}function _e(){const e=X();return Object.values(_).map(t=>({...t,unlocked:e.includes(t.id)}))}function Z(){const e=Object.keys(_).length,t=X().length;return{total:e,unlocked:t,percent:Math.round(t/e*100)}}function je(){const e=new Date().getHours(),t={studiedAtNight:e>=0&&e<5,studiedEarly:e>=5&&e<7},a=X(),o=[];return t.studiedAtNight&&!a.includes("night_owl")&&(a.push("night_owl"),o.push(_.night_owl)),t.studiedEarly&&!a.includes("early_bird")&&(a.push("early_bird"),o.push(_.early_bird)),o.length>0&&ke(a),o}const pe="toast-container";function Oe(){let e=document.getElementById(pe);return e||(e=document.createElement("div"),e.id=pe,e.className="toast-container",document.body.appendChild(e)),e}function L(e,t,a="info",o=4e3){const n=Oe(),s=document.createElement("div"),r={info:"fa-circle-info",success:"fa-circle-check",warning:"fa-triangle-exclamation",error:"fa-circle-xmark"};s.className=`toast ${a}`,s.innerHTML=`
    <i class="fa-solid ${r[a]||"fa-bell"}"></i>
    <div class="toast-content">
      <span class="toast-title">${e}</span>
      <span class="toast-message">${t}</span>
    </div>
  `,n.appendChild(s),o>0&&setTimeout(()=>{s.classList.add("removing"),s.addEventListener("animationend",()=>{s.remove(),n.children.length===0&&n.remove()})},o)}function Fe(e){document.querySelector(".achievement-notification")?.remove();const t=document.createElement("div");t.className="achievement-notification animate__animated animate__fadeInUp",t.innerHTML=`
  ...
  `,document.body.appendChild(t),Ye();const a=()=>{t.classList.add("fade-out"),setTimeout(()=>t.remove(),300)};t.querySelector(".level-up-close").addEventListener("click",a),t.querySelector(".level-up-overlay").addEventListener("click",a),setTimeout(a,5e3)}function Ye(){const e=["#6366f1","#8b5cf6","#ec4899","#f59e0b","#10b981","#3b82f6"];for(let a=0;a<50;a++){const o=document.createElement("div");o.className="confetti",o.style.left=Math.random()*100+"vw",o.style.backgroundColor=e[Math.floor(Math.random()*e.length)],o.style.animationDuration=Math.random()*2+2+"s",o.style.animationDelay=Math.random()*.5+"s",document.body.appendChild(o),setTimeout(()=>o.remove(),4e3)}}function Xe(){const e=je();e.length>0&&Ee(e)}const G=[{id:"a1-complete",name:"A1 - Beginner Pack",icon:"fa-seedling",description:"Lo esencial para sobrevivir: verbos del día a día, conectores básicos, tus primeros phrasal verbs y frases que usarás constantemente.",level:"A1",words:[{word:"Be",meaning:"Ser / Estar",type:"word",category:"Verbos",example:"I am tired. She is my friend."},{word:"Have",meaning:"Tener",type:"word",category:"Verbos",example:"I have a question."},{word:"Want",meaning:"Querer",type:"word",category:"Verbos",example:"I want coffee, please."},{word:"Need",meaning:"Necesitar",type:"word",category:"Verbos",example:"I need help."},{word:"Like",meaning:"Gustar",type:"word",category:"Verbos",example:"I like this song."},{word:"Go",meaning:"Ir",type:"word",category:"Verbos",example:"I go to work by metro."},{word:"Know",meaning:"Saber / Conocer",type:"word",category:"Verbos",example:"I don't know."},{word:"Think",meaning:"Pensar / Creer",type:"word",category:"Verbos",example:"I think so."},{word:"See",meaning:"Ver",type:"word",category:"Verbos",example:"See you tomorrow!"},{word:"Work",meaning:"Trabajar / Funcionar",type:"word",category:"Verbos",example:"It doesn't work."},{word:"And",meaning:"Y",type:"connector",category:"Conectores",example:"Coffee and a sandwich, please."},{word:"But",meaning:"Pero",type:"connector",category:"Conectores",example:"I like it, but it's expensive."},{word:"Or",meaning:"O",type:"connector",category:"Conectores",example:"Tea or coffee?"},{word:"Because",meaning:"Porque",type:"connector",category:"Conectores",example:"I'm late because of the traffic."},{word:"So",meaning:"Así que / Entonces",type:"connector",category:"Conectores",example:"I was hungry, so I ordered food."},{word:"Then",meaning:"Luego / Entonces",type:"connector",category:"Conectores",example:"First we eat, then we go."},{word:"Also",meaning:"También",type:"connector",category:"Conectores",example:"I also want dessert."},{word:"Maybe",meaning:"Quizás / A lo mejor",type:"connector",category:"Conectores",example:"Maybe tomorrow."},{word:"Really",meaning:"De verdad / Muy",type:"connector",category:"Conectores",example:"I'm really tired."},{word:"Actually",meaning:"En realidad",type:"connector",category:"Conectores",example:"Actually, I changed my mind."},{word:"Wake up",meaning:"Despertarse",type:"phrasal",category:"Phrasal Verbs",example:"I wake up at 7."},{word:"Get up",meaning:"Levantarse",type:"phrasal",category:"Phrasal Verbs",example:"Get up, we're late!"},{word:"Turn on",meaning:"Encender",type:"phrasal",category:"Phrasal Verbs",example:"Turn on the lights."},{word:"Turn off",meaning:"Apagar",type:"phrasal",category:"Phrasal Verbs",example:"Turn off your phone."},{word:"Come in",meaning:"Entrar / Pasa",type:"phrasal",category:"Phrasal Verbs",example:"Come in, sit down!"},{word:"Go out",meaning:"Salir",type:"phrasal",category:"Phrasal Verbs",example:"Let's go out tonight."},{word:"Sit down",meaning:"Sentarse",type:"phrasal",category:"Phrasal Verbs",example:"Please sit down."},{word:"Put on",meaning:"Ponerse (ropa)",type:"phrasal",category:"Phrasal Verbs",example:"Put on your jacket, it's cold."},{word:"Take off",meaning:"Quitarse (ropa)",type:"phrasal",category:"Phrasal Verbs",example:"Take off your shoes."},{word:"Look at",meaning:"Mirar",type:"phrasal",category:"Phrasal Verbs",example:"Look at this!"},{word:"How are you?",meaning:"¿Cómo estás?",type:"expression",category:"Expresiones",example:"Hey! How are you?"},{word:"I'm fine, thanks",meaning:"Bien, gracias",type:"expression",category:"Expresiones",example:"I'm fine, thanks. And you?"},{word:"Nice to meet you",meaning:"Encantado/a",type:"expression",category:"Expresiones",example:"Hi, I'm Ana. Nice to meet you."},{word:"See you later",meaning:"Hasta luego",type:"expression",category:"Expresiones",example:"Bye! See you later."},{word:"No problem",meaning:"No hay problema / De nada",type:"expression",category:"Expresiones",example:"Thanks! - No problem."},{word:"I don't understand",meaning:"No entiendo",type:"expression",category:"Expresiones",example:"Sorry, I don't understand."},{word:"Can you repeat?",meaning:"¿Puedes repetir?",type:"expression",category:"Expresiones",example:"Can you repeat, please?"},{word:"Excuse me",meaning:"Disculpa / Perdona",type:"expression",category:"Expresiones",example:"Excuse me, where is the bathroom?"},{word:"I'm sorry",meaning:"Lo siento",type:"expression",category:"Expresiones",example:"I'm sorry, I'm late."},{word:"Of course",meaning:"Por supuesto / Claro",type:"expression",category:"Expresiones",example:"Can I sit here? - Of course!"}]},{id:"a2-complete",name:"A2 - Elementary Pack",icon:"fa-leaf",description:"Para empezar a conversar: verbos de acción, conectores para contar cosas, phrasal verbs súper comunes y expresiones que oyes en todas partes.",level:"A2",words:[{word:"Try",meaning:"Intentar / Probar",type:"word",category:"Verbos",example:"Try this, it's delicious!"},{word:"Wait",meaning:"Esperar",type:"word",category:"Verbos",example:"Wait for me!"},{word:"Tell",meaning:"Decir / Contar",type:"word",category:"Verbos",example:"Tell me more."},{word:"Ask",meaning:"Preguntar / Pedir",type:"word",category:"Verbos",example:"Can I ask you something?"},{word:"Feel",meaning:"Sentir / Sentirse",type:"word",category:"Verbos",example:"I feel tired today."},{word:"Remember",meaning:"Recordar",type:"word",category:"Verbos",example:"I don't remember his name."},{word:"Forget",meaning:"Olvidar",type:"word",category:"Verbos",example:"I forgot my wallet."},{word:"Leave",meaning:"Irse / Dejar",type:"word",category:"Verbos",example:"I'm leaving now."},{word:"Stay",meaning:"Quedarse",type:"word",category:"Verbos",example:"Stay here, I'll be back."},{word:"Send",meaning:"Enviar",type:"word",category:"Verbos",example:"Send me the details."},{word:"After",meaning:"Después de",type:"connector",category:"Conectores",example:"After work, I go to the gym."},{word:"Before",meaning:"Antes de",type:"connector",category:"Conectores",example:"Before I forget..."},{word:"When",meaning:"Cuando",type:"connector",category:"Conectores",example:"When I was young..."},{word:"While",meaning:"Mientras",type:"connector",category:"Conectores",example:"I listen to music while I work."},{word:"If",meaning:"Si (condicional)",type:"connector",category:"Conectores",example:"If you want, we can go."},{word:"Anyway",meaning:"De todas formas / Bueno",type:"connector",category:"Conectores",example:"Anyway, let's go."},{word:"By the way",meaning:"Por cierto",type:"connector",category:"Conectores",example:"By the way, where is John?"},{word:"For example",meaning:"Por ejemplo",type:"connector",category:"Conectores",example:"I like fruits, for example, apples."},{word:"I mean",meaning:"O sea / Quiero decir",type:"connector",category:"Conectores",example:"I mean, it's not bad."},{word:"You know",meaning:"Ya sabes / Sabes",type:"connector",category:"Conectores",example:"It's like, you know, complicated."},{word:"Look for",meaning:"Buscar",type:"phrasal",category:"Phrasal Verbs",example:"I'm looking for my keys."},{word:"Pick up",meaning:"Recoger / Coger",type:"phrasal",category:"Phrasal Verbs",example:"I'll pick you up at 8."},{word:"Give up",meaning:"Rendirse / Dejar de",type:"phrasal",category:"Phrasal Verbs",example:"Don't give up!"},{word:"Come back",meaning:"Volver",type:"phrasal",category:"Phrasal Verbs",example:"When are you coming back?"},{word:"Find out",meaning:"Descubrir / Enterarse",type:"phrasal",category:"Phrasal Verbs",example:"I found out he lied."},{word:"Hurry up",meaning:"Darse prisa",type:"phrasal",category:"Phrasal Verbs",example:"Hurry up, we're late!"},{word:"Grow up",meaning:"Crecer / Madurar",type:"phrasal",category:"Phrasal Verbs",example:"I grew up in Madrid."},{word:"Give back",meaning:"Devolver",type:"phrasal",category:"Phrasal Verbs",example:"Give me back my phone!"},{word:"Write down",meaning:"Apuntar / Anotar",type:"phrasal",category:"Phrasal Verbs",example:"Write down the address."},{word:"Log in",meaning:"Iniciar sesión",type:"phrasal",category:"Phrasal Verbs",example:"Log in with your email."},{word:"What's up?",meaning:"¿Qué pasa? / ¿Qué tal?",type:"expression",category:"Expresiones",example:"Hey! What's up?"},{word:"Take care",meaning:"Cuídate",type:"expression",category:"Expresiones",example:"See you! Take care."},{word:"Good luck",meaning:"Buena suerte",type:"expression",category:"Expresiones",example:"Good luck with your exam!"},{word:"Never mind",meaning:"No importa / Déjalo",type:"expression",category:"Expresiones",example:"Never mind, forget it."},{word:"It doesn't matter",meaning:"No importa / Da igual",type:"expression",category:"Expresiones",example:"It doesn't matter, really."},{word:"I have no idea",meaning:"Ni idea / No tengo ni idea",type:"expression",category:"Expresiones",example:"I have no idea what happened."},{word:"Just a moment",meaning:"Un momento",type:"expression",category:"Expresiones",example:"Just a moment, please."},{word:"That's fine",meaning:"Está bien / Vale",type:"expression",category:"Expresiones",example:"That's fine with me."},{word:"I'm not sure",meaning:"No estoy seguro/a",type:"expression",category:"Expresiones",example:"I'm not sure if I can go."},{word:"Well done!",meaning:"¡Bien hecho!",type:"expression",category:"Expresiones",example:"You passed! Well done!"}]},{id:"b1-complete",name:"B1 - Intermediate Pack",icon:"fa-tree",description:"Para hablar con fluidez: verbos para opinar y expresarte, conectores para no quedarte callado, phrasal verbs esenciales y expresiones que usas cada día.",level:"B1",words:[{word:"Seem",meaning:"Parecer",type:"word",category:"Verbos",example:"It seems like a good idea."},{word:"Guess",meaning:"Suponer / Adivinar",type:"word",category:"Verbos",example:"I guess you're right."},{word:"Expect",meaning:"Esperar (expectativa)",type:"word",category:"Verbos",example:"I didn't expect that."},{word:"Realize",meaning:"Darse cuenta",type:"word",category:"Verbos",example:"I just realized I forgot my wallet."},{word:"Agree",meaning:"Estar de acuerdo",type:"word",category:"Verbos",example:"I totally agree with you."},{word:"Suggest",meaning:"Sugerir",type:"word",category:"Verbos",example:"I suggest we take a break."},{word:"Recommend",meaning:"Recomendar",type:"word",category:"Verbos",example:"I recommend this restaurant."},{word:"Manage",meaning:"Conseguir / Arreglárselas",type:"word",category:"Verbos",example:"I managed to finish on time."},{word:"Afford",meaning:"Permitirse (dinero)",type:"word",category:"Verbos",example:"I can't afford a new car."},{word:"Improve",meaning:"Mejorar",type:"word",category:"Verbos",example:"My English is improving."},{word:"Although",meaning:"Aunque",type:"connector",category:"Conectores",example:"Although it was late, I finished."},{word:"However",meaning:"Sin embargo",type:"connector",category:"Conectores",example:"It's cheap. However, it's bad quality."},{word:"Instead",meaning:"En su lugar",type:"connector",category:"Conectores",example:"Let's do this instead."},{word:"Besides",meaning:"Además",type:"connector",category:"Conectores",example:"It's late, and besides, I'm tired."},{word:"Otherwise",meaning:"Si no / De lo contrario",type:"connector",category:"Conectores",example:"Hurry up, otherwise we'll be late."},{word:"Even though",meaning:"Aunque (enfático)",type:"connector",category:"Conectores",example:"Even though I studied, I failed."},{word:"Basically",meaning:"Básicamente",type:"connector",category:"Conectores",example:"Basically, it's done."},{word:"Apparently",meaning:"Por lo visto / Al parecer",type:"connector",category:"Conectores",example:"Apparently, he quit his job."},{word:"Obviously",meaning:"Obviamente",type:"connector",category:"Conectores",example:"Obviously, I said yes."},{word:"Hopefully",meaning:"Ojalá / Con suerte",type:"connector",category:"Conectores",example:"Hopefully, it will work."},{word:"Figure out",meaning:"Entender / Resolver",type:"phrasal",category:"Phrasal Verbs",example:"I can't figure out this problem."},{word:"Work out",meaning:"Hacer ejercicio / Funcionar",type:"phrasal",category:"Phrasal Verbs",example:"Things will work out, don't worry."},{word:"Show up",meaning:"Aparecer / Presentarse",type:"phrasal",category:"Phrasal Verbs",example:"He didn't show up to the meeting."},{word:"Run out of",meaning:"Quedarse sin",type:"phrasal",category:"Phrasal Verbs",example:"We ran out of milk."},{word:"Get along with",meaning:"Llevarse bien con",type:"phrasal",category:"Phrasal Verbs",example:"I get along with my boss."},{word:"Set up",meaning:"Organizar / Configurar",type:"phrasal",category:"Phrasal Verbs",example:"Let's set up a meeting."},{word:"Catch up",meaning:"Ponerse al día",type:"phrasal",category:"Phrasal Verbs",example:"Let's catch up over coffee!"},{word:"Check out",meaning:"Echar un vistazo",type:"phrasal",category:"Phrasal Verbs",example:"Check out this video!"},{word:"Look forward to",meaning:"Tener ganas de",type:"phrasal",category:"Phrasal Verbs",example:"I'm looking forward to the weekend!"},{word:"Put off",meaning:"Posponer",type:"phrasal",category:"Phrasal Verbs",example:"Stop putting it off, do it now!"},{word:"It's up to you",meaning:"Tú decides / Depende de ti",type:"expression",category:"Expresiones",example:"Pizza or sushi? It's up to you."},{word:"That makes sense",meaning:"Tiene sentido",type:"expression",category:"Expresiones",example:"Oh, that makes sense now!"},{word:"It's not a big deal",meaning:"No es para tanto",type:"expression",category:"Expresiones",example:"Relax, it's not a big deal."},{word:"Let me know",meaning:"Avísame / Dime",type:"expression",category:"Expresiones",example:"Let me know if you need help."},{word:"To be honest",meaning:"Para ser sincero/a",type:"expression",category:"Expresiones",example:"To be honest, I don't like it."},{word:"I'm not in the mood",meaning:"No me apetece",type:"expression",category:"Expresiones",example:"I'm not in the mood for a party."},{word:"Fair enough",meaning:"Me parece bien / Vale",type:"expression",category:"Expresiones",example:"Fair enough, let's do it."},{word:"It depends",meaning:"Depende",type:"expression",category:"Expresiones",example:"Are you coming? It depends."},{word:"That's the thing",meaning:"Esa es la cuestión",type:"expression",category:"Expresiones",example:"That's the thing, I don't know."},{word:"I'll let you know",meaning:"Ya te diré / Te aviso",type:"expression",category:"Expresiones",example:"I'll let you know tomorrow."}]},{id:"b2-complete",name:"B2 - Upper-Intermediate Pack",icon:"fa-mountain",description:"Para sonar natural: verbos que usan los nativos, conectores para debatir, phrasal verbs del día a día y expresiones que escuchas en series y películas.",level:"B2",words:[{word:"Assume",meaning:"Suponer / Asumir",type:"word",category:"Verbos",example:"I assume you know about it."},{word:"Consider",meaning:"Considerar / Plantearse",type:"word",category:"Verbos",example:"Have you considered moving?"},{word:"Tend to",meaning:"Tender a / Soler",type:"word",category:"Verbos",example:"I tend to wake up early."},{word:"Involve",meaning:"Implicar / Involucrar",type:"word",category:"Verbos",example:"What does the job involve?"},{word:"Struggle",meaning:"Luchar / Costar (esfuerzo)",type:"word",category:"Verbos",example:"I struggle with mornings."},{word:"Achieve",meaning:"Lograr / Conseguir",type:"word",category:"Verbos",example:"She achieved her goals."},{word:"Avoid",meaning:"Evitar",type:"word",category:"Verbos",example:"I try to avoid sugar."},{word:"Convince",meaning:"Convencer",type:"word",category:"Verbos",example:"You convinced me!"},{word:"Complain",meaning:"Quejarse",type:"word",category:"Verbos",example:"Stop complaining!"},{word:"Appreciate",meaning:"Agradecer / Valorar",type:"word",category:"Verbos",example:"I really appreciate your help."},{word:"Therefore",meaning:"Por lo tanto",type:"connector",category:"Conectores",example:"It was late, therefore we left."},{word:"Nevertheless",meaning:"Sin embargo / Aun así",type:"connector",category:"Conectores",example:"It was hard. Nevertheless, I did it."},{word:"On the other hand",meaning:"Por otro lado",type:"connector",category:"Conectores",example:"It's cheap, but on the other hand, it's slow."},{word:"In that case",meaning:"En ese caso",type:"connector",category:"Conectores",example:"In that case, count me in!"},{word:"As long as",meaning:"Siempre que / Mientras",type:"connector",category:"Conectores",example:"You can go as long as you're back by 10."},{word:"Unless",meaning:"A menos que",type:"connector",category:"Conectores",example:"I'll go unless it rains."},{word:"Despite",meaning:"A pesar de",type:"connector",category:"Conectores",example:"Despite the rain, we had fun."},{word:"Whereas",meaning:"Mientras que",type:"connector",category:"Conectores",example:"I like tea, whereas he prefers coffee."},{word:"On top of that",meaning:"Además de eso / Encima",type:"connector",category:"Conectores",example:"I'm tired and, on top of that, hungry."},{word:"That being said",meaning:"Dicho esto",type:"connector",category:"Conectores",example:"That being said, I still think it's worth it."},{word:"Come up with",meaning:"Idear / Se me ocurrió",type:"phrasal",category:"Phrasal Verbs",example:"She came up with a great idea."},{word:"Turn out",meaning:"Resultar ser",type:"phrasal",category:"Phrasal Verbs",example:"It turned out to be a good decision."},{word:"Bring up",meaning:"Sacar un tema",type:"phrasal",category:"Phrasal Verbs",example:"Why did you bring that up?"},{word:"Get over",meaning:"Superar",type:"phrasal",category:"Phrasal Verbs",example:"I can't get over it."},{word:"Put up with",meaning:"Aguantar / Tolerar",type:"phrasal",category:"Phrasal Verbs",example:"I can't put up with this noise."},{word:"Get away with",meaning:"Salirse con la suya",type:"phrasal",category:"Phrasal Verbs",example:"You won't get away with this!"},{word:"Hold on",meaning:"Espera / Aguanta",type:"phrasal",category:"Phrasal Verbs",example:"Hold on, I'll be right back."},{word:"Mess up",meaning:"Cagarla / Estropear",type:"phrasal",category:"Phrasal Verbs",example:"I totally messed up."},{word:"Freak out",meaning:"Flipar / Entrar en pánico",type:"phrasal",category:"Phrasal Verbs",example:"Don't freak out, it's fine."},{word:"End up",meaning:"Acabar / Terminar",type:"phrasal",category:"Phrasal Verbs",example:"We ended up staying until midnight."},{word:"No way!",meaning:"¡Ni de broma! / ¡No me digas!",type:"expression",category:"Expresiones",example:"You quit your job? No way!"},{word:"I'm done",meaning:"He terminado / Paso de esto",type:"expression",category:"Expresiones",example:"I'm done with this situation."},{word:"That's insane",meaning:"Eso es una locura",type:"expression",category:"Expresiones",example:"You swam 5km? That's insane!"},{word:"Get the point",meaning:"Captar la idea / Entender",type:"expression",category:"Expresiones",example:"I get the point, you can stop."},{word:"You're kidding",meaning:"Estás de broma",type:"expression",category:"Expresiones",example:"You won? You're kidding!"},{word:"I couldn't care less",meaning:"Me importa un bledo",type:"expression",category:"Expresiones",example:"I couldn't care less about what he thinks."},{word:"That's not the point",meaning:"Esa no es la cuestión",type:"expression",category:"Expresiones",example:"Yeah but that's not the point."},{word:"Keep it real",meaning:"Sé auténtico / Sin rollos",type:"expression",category:"Expresiones",example:"Forget the drama, keep it real."},{word:"Been there, done that",meaning:"Ya pasé por eso",type:"expression",category:"Expresiones",example:"Drama at work? Been there, done that."},{word:"It is what it is",meaning:"Es lo que hay",type:"expression",category:"Expresiones",example:"The deadline is tomorrow. It is what it is."}]},{id:"c1-complete",name:"C1 - Advanced Pack",icon:"fa-rocket",description:"Para sonar sofisticado: verbos de trabajo y negocios, conectores elegantes pero naturales, phrasal verbs de nivel nativo y expresiones de persona culta.",level:"C1",words:[{word:"Address",meaning:"Abordar / Tratar (un tema)",type:"word",category:"Verbos",example:"We need to address this issue."},{word:"Implement",meaning:"Implementar",type:"word",category:"Verbos",example:"We'll implement the changes next week."},{word:"Ensure",meaning:"Asegurar(se)",type:"word",category:"Verbos",example:"Please ensure everyone is informed."},{word:"Clarify",meaning:"Aclarar",type:"word",category:"Verbos",example:"Let me clarify what I mean."},{word:"Prioritize",meaning:"Priorizar",type:"word",category:"Verbos",example:"We need to prioritize this task."},{word:"Overcome",meaning:"Superar",type:"word",category:"Verbos",example:"She overcame many challenges."},{word:"Acknowledge",meaning:"Reconocer / Admitir",type:"word",category:"Verbos",example:"I acknowledge my mistake."},{word:"Pursue",meaning:"Perseguir (objetivo)",type:"word",category:"Verbos",example:"She decided to pursue her dreams."},{word:"Delegate",meaning:"Delegar",type:"word",category:"Verbos",example:"Learn to delegate tasks."},{word:"Leverage",meaning:"Aprovechar / Sacar partido",type:"word",category:"Verbos",example:"Let's leverage our experience."},{word:"Having said that",meaning:"Dicho esto",type:"connector",category:"Conectores",example:"It's expensive. Having said that, it's worth it."},{word:"That said",meaning:"Dicho esto (más corto)",type:"connector",category:"Conectores",example:"He's difficult. That said, he's talented."},{word:"Either way",meaning:"De cualquier forma",type:"connector",category:"Conectores",example:"Either way, we need to decide."},{word:"At the end of the day",meaning:"Al fin y al cabo",type:"connector",category:"Conectores",example:"At the end of the day, it's your choice."},{word:"To be fair",meaning:"Para ser justos",type:"connector",category:"Conectores",example:"To be fair, he did apologize."},{word:"As a matter of fact",meaning:"De hecho",type:"connector",category:"Conectores",example:"As a matter of fact, I agree with you."},{word:"For what it's worth",meaning:"Por lo que pueda valer",type:"connector",category:"Conectores",example:"For what it's worth, I think you're great."},{word:"Mind you",meaning:"Eso sí / Aunque",type:"connector",category:"Conectores",example:"Good restaurant. Mind you, it's pricey."},{word:"Not to mention",meaning:"Por no hablar de",type:"connector",category:"Conectores",example:"It's cold, not to mention raining."},{word:"In a nutshell",meaning:"En resumen / Resumiendo",type:"connector",category:"Conectores",example:"In a nutshell, we need more time."},{word:"Play it down",meaning:"Quitarle importancia",type:"phrasal",category:"Phrasal Verbs",example:"Don't play it down, it's serious."},{word:"Rule out",meaning:"Descartar",type:"phrasal",category:"Phrasal Verbs",example:"We can't rule out that option."},{word:"Back out",meaning:"Echarse atrás",type:"phrasal",category:"Phrasal Verbs",example:"He backed out at the last minute."},{word:"Step up",meaning:"Dar un paso al frente",type:"phrasal",category:"Phrasal Verbs",example:"Someone needs to step up."},{word:"Fall through",meaning:"Fracasar / No salir adelante",type:"phrasal",category:"Phrasal Verbs",example:"The deal fell through."},{word:"Look into",meaning:"Investigar / Estudiar",type:"phrasal",category:"Phrasal Verbs",example:"I'll look into it."},{word:"Iron out",meaning:"Resolver / Limar",type:"phrasal",category:"Phrasal Verbs",example:"Let's iron out the details."},{word:"Pull off",meaning:"Lograr (algo difícil)",type:"phrasal",category:"Phrasal Verbs",example:"I can't believe we pulled it off!"},{word:"Get back to",meaning:"Volver a contactar",type:"phrasal",category:"Phrasal Verbs",example:"I'll get back to you on that."},{word:"Follow through",meaning:"Cumplir / Llevar a cabo",type:"phrasal",category:"Phrasal Verbs",example:"Make sure you follow through."},{word:"The thing is",meaning:"El caso es / La cosa es que",type:"expression",category:"Expresiones",example:"The thing is, I need more time."},{word:"To cut a long story short",meaning:"Resumiendo / Yendo al grano",type:"expression",category:"Expresiones",example:"To cut a long story short, we won."},{word:"Go the extra mile",meaning:"Hacer un esfuerzo extra",type:"expression",category:"Expresiones",example:"She always goes the extra mile."},{word:"Be on the same page",meaning:"Estar en la misma onda",type:"expression",category:"Expresiones",example:"Let's make sure we're on the same page."},{word:"Think outside the box",meaning:"Pensar de forma creativa",type:"expression",category:"Expresiones",example:"We need to think outside the box."},{word:"Hit the ground running",meaning:"Empezar con buen pie",type:"expression",category:"Expresiones",example:"I want to hit the ground running."},{word:"A steep learning curve",meaning:"Una curva de aprendizaje",type:"expression",category:"Expresiones",example:"This job has a steep learning curve."},{word:"Touch base",meaning:"Ponerse en contacto",type:"expression",category:"Expresiones",example:"Let's touch base next week."},{word:"Get the ball rolling",meaning:"Poner algo en marcha",type:"expression",category:"Expresiones",example:"Let's get the ball rolling."},{word:"Keep me in the loop",meaning:"Mantenme informado",type:"expression",category:"Expresiones",example:"Keep me in the loop, please."}]},{id:"c2-complete",name:"C2 - Proficiency Pack",icon:"fa-crown",description:"Para impresionar: verbos precisos de alto nivel, conectores para argumentar con elegancia, phrasal verbs sutiles e idioms para sonar como un nativo educado.",level:"C2",words:[{word:"Anticipate",meaning:"Anticipar / Prever",type:"word",category:"Verbos",example:"We didn't anticipate this problem."},{word:"Undermine",meaning:"Socavar / Minar",type:"word",category:"Verbos",example:"Don't undermine my authority."},{word:"Advocate",meaning:"Defender / Abogar por",type:"word",category:"Verbos",example:"I advocate for change."},{word:"Tackle",meaning:"Abordar / Hacer frente a",type:"word",category:"Verbos",example:"Let's tackle this problem."},{word:"Navigate",meaning:"Navegar / Manejarse en",type:"word",category:"Verbos",example:"It's hard to navigate office politics."},{word:"Thrive",meaning:"Prosperar / Florecer",type:"word",category:"Verbos",example:"She thrives under pressure."},{word:"Resonate",meaning:"Resonar / Conectar (con)",type:"word",category:"Verbos",example:"This message resonates with me."},{word:"Overlook",meaning:"Pasar por alto / Ignorar",type:"word",category:"Verbos",example:"Don't overlook the details."},{word:"Embrace",meaning:"Abrazar / Aceptar",type:"word",category:"Verbos",example:"Embrace change."},{word:"Streamline",meaning:"Simplificar / Optimizar",type:"word",category:"Verbos",example:"We need to streamline the process."},{word:"Be that as it may",meaning:"Sea como sea",type:"connector",category:"Conectores",example:"Be that as it may, we still need to act."},{word:"More often than not",meaning:"La mayoría de las veces",type:"connector",category:"Conectores",example:"More often than not, he's right."},{word:"By and large",meaning:"En general",type:"connector",category:"Conectores",example:"By and large, people are kind."},{word:"All things considered",meaning:"Teniendo todo en cuenta",type:"connector",category:"Conectores",example:"All things considered, it was a success."},{word:"For the most part",meaning:"En su mayor parte",type:"connector",category:"Conectores",example:"For the most part, I agree."},{word:"On balance",meaning:"Sopesándolo todo",type:"connector",category:"Conectores",example:"On balance, it was worth it."},{word:"As it turns out",meaning:"Resulta que",type:"connector",category:"Conectores",example:"As it turns out, I was wrong."},{word:"Needless to say",meaning:"Ni que decir tiene",type:"connector",category:"Conectores",example:"Needless to say, I was shocked."},{word:"That notwithstanding",meaning:"A pesar de eso",type:"connector",category:"Conectores",example:"That notwithstanding, we should proceed."},{word:"With that in mind",meaning:"Teniendo eso en cuenta",type:"connector",category:"Conectores",example:"With that in mind, let's continue."},{word:"Brush off",meaning:"Ignorar / No hacer caso",type:"phrasal",category:"Phrasal Verbs",example:"Don't brush off my concerns."},{word:"Chime in",meaning:"Intervenir / Meter baza",type:"phrasal",category:"Phrasal Verbs",example:"Feel free to chime in."},{word:"Pan out",meaning:"Resultar / Salir",type:"phrasal",category:"Phrasal Verbs",example:"Let's see how things pan out."},{word:"Touch on",meaning:"Tocar / Mencionar brevemente",type:"phrasal",category:"Phrasal Verbs",example:"I'd like to touch on one point."},{word:"Zone out",meaning:"Desconectar / Quedarse en blanco",type:"phrasal",category:"Phrasal Verbs",example:"Sorry, I zoned out for a moment."},{word:"Play up",meaning:"Exagerar / Dar problemas",type:"phrasal",category:"Phrasal Verbs",example:"My back is playing up again."},{word:"Kick in",meaning:"Empezar a hacer efecto",type:"phrasal",category:"Phrasal Verbs",example:"The coffee is starting to kick in."},{word:"Wind down",meaning:"Relajarse / Ir terminando",type:"phrasal",category:"Phrasal Verbs",example:"Time to wind down for the day."},{word:"Mull over",meaning:"Darle vueltas a",type:"phrasal",category:"Phrasal Verbs",example:"I need to mull it over."},{word:"Stumble upon",meaning:"Encontrar por casualidad",type:"phrasal",category:"Phrasal Verbs",example:"I stumbled upon this article."},{word:"The elephant in the room",meaning:"El tema incómodo que nadie menciona",type:"expression",category:"Expresiones",example:"Let's address the elephant in the room."},{word:"A blessing in disguise",meaning:"Una bendición disfrazada",type:"expression",category:"Expresiones",example:"Losing that job was a blessing in disguise."},{word:"Break the ice",meaning:"Romper el hielo",type:"expression",category:"Expresiones",example:"Let's play a game to break the ice."},{word:"Hit the nail on the head",meaning:"Dar en el clavo",type:"expression",category:"Expresiones",example:"You hit the nail on the head."},{word:"Easier said than done",meaning:"Del dicho al hecho hay un trecho",type:"expression",category:"Expresiones",example:"Getting fit is easier said than done."},{word:"The ball is in your court",meaning:"Te toca a ti",type:"expression",category:"Expresiones",example:"I made my offer, the ball is in your court."},{word:"Read the room",meaning:"Leer el ambiente",type:"expression",category:"Expresiones",example:"You need to learn to read the room."},{word:"Miss the boat",meaning:"Perder la oportunidad",type:"expression",category:"Expresiones",example:"If you don't apply now, you'll miss the boat."},{word:"Put your foot in your mouth",meaning:"Meter la pata",type:"expression",category:"Expresiones",example:"I really put my foot in my mouth there."},{word:"Under the weather",meaning:"Pachucho / Indispuesto",type:"expression",category:"Expresiones",example:"I'm feeling a bit under the weather."}]}],Je={accent:"en-US",speed:1};function ne(){return j().tts||Je}function me(e){const t=j();t.tts={...ne(),...e},we(t)}function D(e,t={}){if(!("speechSynthesis"in window)){L("Error","Tu navegador no soporta síntesis de voz.","error");return}window.speechSynthesis.cancel();const a=ne(),o=t.accent||a.accent,n=t.speed||a.speed,s=new SpeechSynthesisUtterance(e);s.lang=o,s.rate=n;const r=window.speechSynthesis.getVoices(),u=r.find(c=>c.lang.startsWith(o.substring(0,2))&&c.lang===o&&(c.name.includes("Google")||c.name.includes("Premium")||c.name.includes("Microsoft")))||r.find(c=>c.lang===o);u&&(s.voice=u),s.onerror=c=>{console.error("TTS Error:",c),L("Error","No se pudo reproducir el audio.","error")},window.speechSynthesis.speak(s)}function Ke(e){return{"en-US":"🇺🇸 Americano","en-GB":"🇬🇧 Británico"}[e]||e}function Ze(e){return e<=.6?"🐢 Muy lento":e<=.8?"🐌 Lento":e<=1.1?"🎯 Normal":e<=1.3?"🐇 Rápido":"⚡ Muy rápido"}function Qe(e,t){const a=document.createElement("div");a.className="word-card",a.dataset.wordId=e.id;const o=e.reviewCount||0,n=e.createdAt?new Date(e.createdAt).toLocaleDateString():"",s=Ve(e),r=qe(e),u=Me(e);return a.innerHTML=`
    ...
    <div class="word-info">
      ...
      <div class="word-meta">
        ...
        ${!u&&e.nextReviewAt?`<span class="meta-item next-review"><i class="fa-solid fa-calendar-check"></i> Próximo: ${r}</span>`:""}
  ...
  `,a.querySelector(".speak-btn").addEventListener("click",c=>{c.stopPropagation(),D(e.word)}),a.querySelector(".toggle").addEventListener("click",()=>{e.remembered=!e.remembered,ae(e),t()}),a.querySelector(".delete").addEventListener("click",()=>{confirm(`¿Eliminar "${e.word}"?`)&&(Ae(e.id),t())}),a.querySelector(".edit-btn").addEventListener("click",()=>{ea(e,t)}),a}function ea(e,t){document.querySelector(".edit-modal")?.remove();const a=document.createElement("div");a.className="edit-modal",a.innerHTML=`
      ...
      <form class="edit-form">
        <div class="form-row">
          <div class="form-field">
            ...
            <input type="text" id="edit-word" value="${W(e.word)}" required />
          </div>
          <div class="form-field">
            <label><i class="fa-solid fa-language"></i> Significado</label>
            <input type="text" id="edit-meaning" value="${W(e.meaning)}" required />
          </div>
        </div>
        <div class="form-row">
          <div class="form-field">
          ...
          <div class="form-field">
            ...
            <input type="text" id="edit-category" value="${W(e.category||"")}" />
          </div>
        </div>
        <div class="form-field">
          <label><i class="fa-solid fa-heart"></i> Asociación emocional</label>
          <textarea id="edit-emotion" rows="3">${W(e.emotion||"")}</textarea>
        </div>
        <div class="form-field">
          <label><i class="fa-solid fa-quote-left"></i> Ejemplo</label>
          <input type="text" id="edit-example" value="${W(e.example||"")}" />
        </div>
        <div class="form-field">
          ...
          <div class="image-tab-content" id="tab-url">
            <input type="url" id="edit-image" value="${W(e.image||"")}" placeholder="https://ejemplo.com/imagen.jpg" />
          </div>
          ...
          ${e.image?`<div class="image-preview-mini"><img src="${W(e.image)}" alt="Preview" /></div>`:""}
        </div>
  ...
  `,document.body.appendChild(a),requestAnimationFrame(()=>{a.classList.add("active")});const o=()=>{a.classList.remove("active"),setTimeout(()=>a.remove(),300)};a.querySelector(".modal-overlay").addEventListener("click",o),a.querySelector(".modal-close").addEventListener("click",o),a.querySelector(".btn-cancel").addEventListener("click",o);let n=null;a.querySelectorAll(".image-tab").forEach(c=>{c.addEventListener("click",()=>{a.querySelectorAll(".image-tab").forEach(l=>l.classList.remove("active")),c.classList.add("active");const y=c.dataset.tab;a.querySelector("#tab-url").style.display=y==="url"?"block":"none",a.querySelector("#tab-upload").style.display=y==="upload"?"block":"none"})});const s=a.querySelector("#edit-image-file"),r=a.querySelector("#edit-dropzone");if(s&&r){let c=function(y){const l=new FileReader;l.onload=E=>{n=E.target.result,r.classList.add("has-file");const w=r.querySelector(".dropzone-text"),S=r.querySelector(".dropzone-subtext");w&&(w.textContent=y.name),S&&(S.textContent=`${(y.size/1024).toFixed(1)} KB`);let d=a.querySelector(".image-preview-mini");d||(d=document.createElement("div"),d.className="image-preview-mini",r.parentElement.after(d)),d.innerHTML=`<img src="${n}" alt="Preview" />`},l.readAsDataURL(y)};var u=c;["dragenter","dragover"].forEach(y=>{r.addEventListener(y,l=>{l.preventDefault(),r.classList.add("dragover")})}),["dragleave","drop"].forEach(y=>{r.addEventListener(y,l=>{l.preventDefault(),r.classList.remove("dragover")})}),r.addEventListener("drop",y=>{const l=y.dataTransfer.files[0];l&&l.type.startsWith("image/")&&c(l)}),s.addEventListener("change",y=>{const l=y.target.files[0];l&&c(l)})}a.querySelector(".edit-form").addEventListener("submit",c=>{c.preventDefault();const y=document.getElementById("edit-word").value.trim(),l=a.querySelector(".edit-feedback");if(he(y,e.id)){l.textContent=`La palabra "${y}" ya existe.`,l.style.display="block";return}e.word=y,e.meaning=document.getElementById("edit-meaning").value.trim(),e.type=document.getElementById("edit-type").value,e.category=document.getElementById("edit-category").value.trim()||null,e.emotion=document.getElementById("edit-emotion").value.trim(),e.example=document.getElementById("edit-example").value.trim(),n?e.image=n:e.image=document.getElementById("edit-image").value.trim(),ae(e),o(),t()}),document.addEventListener("keydown",function c(y){y.key==="Escape"&&(o(),document.removeEventListener("keydown",c))})}function W(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}function aa(e){switch(e){case"word":return'<i class="fa-solid fa-font"></i> Palabra';case"phrasal":return'<i class="fa-solid fa-link"></i> Phrasal Verb';case"expression":return'<i class="fa-solid fa-comment"></i> Expresión';case"connector":return'<i class="fa-solid fa-arrows-left-right"></i> Conector';default:return'<i class="fa-solid fa-file"></i> Otro'}}function ee(e){const t=te(),a=ve(),o=Q(),n=24,s=2*Math.PI*n,r=Math.min(o.dailyGoal.count/o.dailyGoal.target,1),u=s-r*s,c=t.total>0;e.innerHTML=`
      ...
      <div class="gamification-hub animate__animated animate__fadeIn">
        ...
        <div class="stat-card level-card">
           ...
           <div class="stat-content full">
              ...
              <div class="xp-progress-container">
                 <div class="xp-bar" style="width: ${oa(o.totalXp,o.level)}%"></div>
              </div>
              <div class="xp-meta">
                 <span>${o.totalXp} XP Totales</span>
                 <span>Siguiente: ${ta(o.level)} XP</span>
              </div>
           </div>
        </div>
        ...
        <div class="stat-card daily-goal-card">
          ...
          <div class="stat-content">
             ...
             <span class="goal-msg-sm">${na(o.dailyGoal.count,o.dailyGoal.target)}</span>
          </div>
  ...
  `;const y=document.getElementById("word-list"),l=document.getElementById("filter-mastery"),E=document.getElementById("filter-type"),w=document.getElementById("filter-category"),S=document.getElementById("sort-by"),d=document.getElementById("search-input"),x=document.getElementById("clear-search"),I=document.getElementById("results-info"),$=document.getElementById("export-btn"),B=document.getElementById("import-btn"),C=document.getElementById("import-file");function P(){y.innerHTML="";let i=d.value.trim()?Te(d.value.trim()):T();const m=Date.now();i=i.filter(p=>{let g=!0;l.value!=="all"&&(l.value==="due"?g=!p.nextReviewAt||p.nextReviewAt<=m:g=fe(p)===l.value);const v=E.value==="all"||p.type===E.value,f=w.value==="all"||p.category===w.value;return g&&v&&f}),i=Pe(i,S.value);const b=T().length;if(d.value.trim()?(I.innerHTML=`<span class="results-count">${i.length} resultados</span> para "<strong>${d.value}</strong>"`,I.style.display="block"):i.length!==b?(I.innerHTML=`<span class="results-count">${i.length} de ${b}</span> palabras`,I.style.display="block"):I.style.display="none",i.length===0){y.innerHTML=`
        <div class="empty-state">
          <div class="empty-icon"><i class="fa-solid fa-book-open"></i></div>
          <h3>${d.value.trim()?"No se encontraron resultados":"Tu vocabulario está vacío"}</h3>
          <p>${d.value.trim()?"Intenta con otra búsqueda.":"Empieza añadiendo tu primera palabra o carga un pack de inicio para arrancar."}</p>
          ...
          ${d.value.trim()?"":`
            ...
            <div class="starter-packs-section">
              ...
              <div class="starter-packs-grid">
                ${G.map(g=>`
                  <div class="pack-card" data-pack-id="${g.id}">
                    <div class="pack-check"><i class="fa-solid fa-circle-check"></i></div>
                    <div class="pack-icon"><i class="fa-solid ${g.icon}"></i></div>
                    <div class="pack-info">
                      <h4>${g.name}</h4>
                      <p>${g.description}</p>
                      <div class="pack-count"><i class="fa-solid fa-layer-group"></i> ${g.words.length} palabras</div>
                    </div>
                  </div>
                `).join("")}
              </div>
      ...
      `;const p=y.querySelector("#import-packs-btn");if(p){let g=new Set;const v=()=>{const f=g.size;if(p.disabled=f===0,f===0)p.textContent="Selecciona packs",p.classList.remove("active");else{let k=0;g.forEach(A=>{const M=G.find(N=>N.id===A);M&&(k+=M.words.length)}),p.innerHTML=`<i class="fa-solid fa-download"></i> Añadir ${f} pack${f>1?"s":""} (${k} palabras)`,p.classList.add("active")}};y.querySelectorAll(".pack-card").forEach(f=>{f.addEventListener("click",()=>{const k=f.dataset.packId;g.has(k)?(g.delete(k),f.classList.remove("selected")):(g.add(k),f.classList.add("selected")),v()})}),p.addEventListener("click",()=>{if(g.size!==0&&confirm(`¿Añadir ${g.size} packs a tu vocabulario?`)){let f=[];g.forEach(M=>{const N=G.find(Le=>Le.id===M);N&&(f=f.concat(N.words))});const k=JSON.stringify({words:f}),A=K(k);A.success?(L("Packs añadidos",`¡Genial! Se han añadido ${A.imported} palabras nuevas.`,"success"),ee(e)):L("Error","Hubo un problema al cargar los packs.","error")}})}}else i.forEach(p=>{y.appendChild(Qe(p,P))})}l.addEventListener("change",P),E.addEventListener("change",P),w.addEventListener("change",P),S.addEventListener("change",P);let V;d.addEventListener("input",()=>{x.style.display=d.value?"flex":"none",clearTimeout(V),V=setTimeout(P,300)}),x.addEventListener("click",()=>{d.value="",x.style.display="none",P()}),$.addEventListener("click",()=>{const i=Ne(),m=new Blob([i],{type:"application/json"}),b=URL.createObjectURL(m),p=document.createElement("a");p.href=b,p.download=`emowords-backup-${new Date().toISOString().split("T")[0]}.json`,p.click(),URL.revokeObjectURL(b)}),B.addEventListener("click",()=>{C.click()}),C.addEventListener("change",i=>{const m=i.target.files[0];if(!m)return;const b=m.name.toLowerCase().endsWith(".csv"),p=new FileReader;p.onload=g=>{const v=g.target.result;let f;if(b)if(f=We(v),f.success){let k=`${f.imported} palabras importadas.`;f.duplicates>0&&(k+=` ${f.duplicates} duplicadas omitidas.`),f.skipped>0&&(k+=` ${f.skipped} con errores.`),L("Importación CSV completada",k,"success"),setTimeout(()=>location.reload(),1500)}else L("Error de importación CSV",f.error,"error");else f=K(v),f.success?(L("Importación completada",`${f.imported} palabras importadas.`,"success"),setTimeout(()=>location.reload(),1500)):L("Error de importación",f.error,"error")},p.readAsText(m),i.target.value=""});const z=document.getElementById("goal-settings-btn");z&&z.addEventListener("click",()=>{h()});const R=document.getElementById("explore-packs-btn");R&&R.addEventListener("click",()=>{J()});function J(){document.querySelector(".packs-modal")?.remove();let i=new Set;const m=document.createElement("div");m.className="packs-modal edit-modal",m.innerHTML=`
      <div class="modal-overlay"></div>
    ...
    `,document.body.appendChild(m),requestAnimationFrame(()=>{m.classList.add("active")});const b=()=>{m.classList.remove("active"),setTimeout(()=>m.remove(),300)};m.querySelector(".modal-overlay").addEventListener("click",b),m.querySelector(".modal-close").addEventListener("click",b),m.querySelector(".btn-cancel").addEventListener("click",b);const p=m.querySelector(".btn-import-packs"),g=()=>{const v=i.size;if(p.disabled=v===0,v===0)p.textContent="Selecciona packs";else{let f=0;i.forEach(k=>{const A=G.find(M=>M.id===k);A&&(f+=A.words.length)}),p.innerHTML=`<i class="fa-solid fa-download"></i> Añadir ${v} pack${v>1?"s":""} (${f} palabras)`}};m.querySelectorAll(".pack-card-modal").forEach(v=>{v.addEventListener("click",()=>{const f=v.dataset.packId;i.has(f)?(i.delete(f),v.classList.remove("selected")):(i.add(f),v.classList.add("selected")),g()})}),p.addEventListener("click",()=>{if(i.size===0)return;let v=[];i.forEach(k=>{const A=G.find(M=>M.id===k);A&&(v=[...v,...A.words])});const f=K(JSON.stringify({words:v}));f.success?(L("¡Packs importados!",`Se añadieron ${f.imported} palabras.`,"success"),b(),setTimeout(()=>location.reload(),1e3)):L("Error",f.error,"error")})}function h(){document.querySelector(".goal-settings-modal")?.remove();const i=Q().dailyGoal.target,m=[5,10,15,20,30,50],b=document.createElement("div");b.className="goal-settings-modal edit-modal",b.innerHTML=`
      <div class="modal-overlay"></div>
      <div class="modal-content" style="max-width: 400px;">
        ...
        <div class="goal-options-grid">
          ${m.map(g=>`
            <button class="goal-option ${g===i?"active":""}" data-value="${g}">
              <span class="goal-number">${g}</span>
    ...
    `,document.body.appendChild(b),requestAnimationFrame(()=>{b.classList.add("active")});const p=()=>{b.classList.remove("active"),setTimeout(()=>b.remove(),300)};b.querySelector(".modal-overlay").addEventListener("click",p),b.querySelector(".modal-close").addEventListener("click",p),b.querySelector(".btn-cancel").addEventListener("click",p),b.querySelectorAll(".goal-option").forEach(g=>{g.addEventListener("click",()=>{const v=parseInt(g.dataset.value);ze(v),L("Meta actualizada",`Tu nueva meta diaria es ${v} palabras.`,"success"),p(),ee(e)})}),document.addEventListener("keydown",function g(v){v.key==="Escape"&&(p(),document.removeEventListener("keydown",g))})}P()}function ta(e){return 100*Math.pow(e,2)}function oa(e,t){const a=100*Math.pow(t-1,2),n=100*Math.pow(t,2)-a,s=e-a;return Math.min(100,Math.max(0,s/n*100))}function na(e,t){return e>=t?"¡Objetivo completado!":e>=t*.75?"¡Casi lo tienes!":e>=t*.5?"¡Ya vas por la mitad!":"¡Vamos a por ello!"}function sa(e){const t=ve();e.innerHTML=`
...
Ejemplo: Mi coche se averió en la autopista y tuve que esperar 2 horas bajo la lluvia..."></textarea>
  ...
  `;const a=document.getElementById("add-word-form"),o=document.getElementById("image-preview"),n=document.getElementById("preview-img"),s=document.getElementById("remove-preview"),r=document.getElementById("clear-form"),u=document.getElementById("image-data"),c=document.querySelectorAll(".image-tab"),y=document.querySelectorAll(".image-tab-content"),l=document.getElementById("upload-area"),E=document.getElementById("image-file"),w=document.getElementById("image-url"),S=document.getElementById("preview-url-btn");c.forEach(x=>{x.addEventListener("click",()=>{const I=x.dataset.tab;c.forEach($=>$.classList.remove("active")),x.classList.add("active"),y.forEach($=>{$.classList.remove("active"),$.id===`${I}-content`&&$.classList.add("active")})})}),l.addEventListener("click",()=>{E.click()}),l.addEventListener("dragover",x=>{x.preventDefault(),l.classList.add("dragover")}),l.addEventListener("dragleave",()=>{l.classList.remove("dragover")}),l.addEventListener("drop",x=>{x.preventDefault(),l.classList.remove("dragover");const I=x.dataTransfer.files;I.length>0&&d(I[0])}),E.addEventListener("change",x=>{x.target.files.length>0&&d(x.target.files[0])});function d(x){if(!x.type.startsWith("image/")){L("Archivo inválido","Por favor selecciona un archivo de imagen.","error");return}const I=2*1024*1024;if(x.size>I){L("Imagen muy grande","La imagen debe ser menor a 2MB.","error");return}const $=new FileReader;$.onload=B=>{const C=B.target.result;n.src=C,o.style.display="block",u.value=C,l.classList.add("has-file"),L("Imagen cargada","La imagen se ha cargado correctamente.","success")},$.onerror=()=>{L("Error","No se pudo leer la imagen.","error")},$.readAsDataURL(x)}S.addEventListener("click",()=>{const x=w.value.trim();x&&(n.src=x,o.style.display="block",u.value=x,n.onerror=()=>{o.style.display="none",u.value="",L("Error de imagen","No se pudo cargar la imagen. Verifica la URL.","warning")})}),w.addEventListener("keypress",x=>{x.key==="Enter"&&(x.preventDefault(),S.click())}),s.addEventListener("click",()=>{w.value="",E.value="",u.value="",o.style.display="none",n.src="",l.classList.remove("has-file")}),r.addEventListener("click",()=>{a.reset(),o.style.display="none",n.src="",u.value="",l.classList.remove("has-file")}),a.addEventListener("submit",x=>{x.preventDefault();const I=document.getElementById("word").value.trim(),$=document.getElementById("meaning").value.trim(),B=document.getElementById("type").value,C=document.getElementById("category").value.trim(),P=document.getElementById("emotion").value.trim(),V=document.getElementById("example").value.trim(),z=u.value.trim();if(!I||!$){L("Faltan datos","Por favor completa al menos la palabra y su significado.","error");return}if(he(I)){L("Palabra duplicada",`La palabra "${I}" ya existe en tu vocabulario.`,"error");return}const R={id:Date.now(),word:I,meaning:$,type:B,category:C||null,emotion:P,example:V,image:z,remembered:!1};Ce(R),a.reset(),o.style.display="none",n.src="",u.value="",l.classList.remove("has-file"),L("¡Guardado!",`"${I}" se ha añadido correctamente.`,"success"),document.getElementById("word").focus()})}const ra="modulepreload",ia=function(e){return"/emowords/"+e},ue={},la=function(t,a,o){let n=Promise.resolve();if(a&&a.length>0){let y=function(l){return Promise.all(l.map(E=>Promise.resolve(E).then(w=>({status:"fulfilled",value:w}),w=>({status:"rejected",reason:w}))))};var r=y;document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),c=u?.nonce||u?.getAttribute("nonce");n=y(a.map(l=>{if(l=ia(l),l in ue)return;ue[l]=!0;const E=l.endsWith(".css"),w=E?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${w}`))return;const S=document.createElement("link");if(S.rel=E?"stylesheet":ra,E||(S.as="script"),S.crossOrigin="",S.href=l,c&&S.setAttribute("nonce",c),document.head.appendChild(S),E)return new Promise((d,x)=>{S.addEventListener("load",d),S.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(u){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=u,window.dispatchEvent(c),!c.defaultPrevented)throw u}return n.then(u=>{for(const c of u||[])c.status==="rejected"&&s(c.reason);return t().catch(s)})};function ca(e){let t=null,a=null,o=!1,n=[],s={correct:0,incorrect:0,xp:0},r=new Map;const u=2;n=Re(),R(n);function c(){e.innerHTML="",t||y()}function y(){const h=n.length;e.innerHTML=`
    ...
    `,e.querySelectorAll(".mode-card").forEach(i=>{i.addEventListener("click",()=>{if(t=i.dataset.mode,console.log(`Starting mode: ${t} with queue size: ${n.length}`),n.length===0){L("Sin palabras","No hay palabras pendientes para repasar ahora.","info"),P(e);return}c(),l(),d()})})}function l(){if(e.querySelector(".review-header"))return;const h=document.createElement("div");h.className="review-header",h.innerHTML=`
     ...
     `,e.insertBefore(h,e.firstChild),document.getElementById("exit-mode").addEventListener("click",b=>{b.preventDefault(),s.correct>0||s.incorrect>0?confirm("¿Salir del modo repaso? Tu progreso se perderá.")&&w():w()});const m=document.createElement("div");m.id="active-content",m.className="review-container",e.appendChild(m)}function E(){const h=document.querySelector("#stat-queue .val"),i=document.querySelector("#stat-correct .val"),m=document.querySelector("#stat-xp .val");h&&(h.textContent=n.length),i&&(i.textContent=s.correct),m&&(m.textContent=`${s.xp} XP`)}function w(){t=null,c()}function S(){return n.shift()||null}function d(){if(!t){c();return}const h=document.getElementById("active-content");if(!h){c();return}if(a=S(),!a){P(h);return}let i=t;if(t==="mixed"){const m=["flashcard","quiz","typing","listening"];i=m[Math.floor(Math.random()*m.length)]}switch(i){case"flashcard":x(h);break;case"quiz":I(h);break;case"typing":$(h);break;case"listening":B(h);break}}function x(h){o=!1,a.reviewCount,h.innerHTML=`
    ...
    `,document.getElementById("review-speak-btn").addEventListener("click",g=>{g.stopPropagation(),D(a.word)});const i=document.getElementById("show-answer"),m=document.getElementById("review-answer"),b=document.getElementById("remembered-btn"),p=document.getElementById("forgotten-btn");i.addEventListener("click",()=>{o=!0,m.style.display="block",i.style.display="none",b.disabled=!1,p.disabled=!1,m.classList.add("fade-in")}),b.addEventListener("click",()=>C(!0)),p.addEventListener("click",()=>C(!1)),z(g=>{g==="Space"&&!o&&i.click(),g==="ArrowRight"&&o&&C(!0),g==="ArrowLeft"&&o&&C(!1)})}function I(h){const m=T().filter(v=>v.id!==a.id).sort(()=>.5-Math.random()).slice(0,3),b=[a,...m];R(b),h.innerHTML=`
    ...
    `,document.getElementById("quiz-speak-btn").addEventListener("click",()=>D(a.word));const p=h.querySelectorAll(".quiz-option");let g=!1;p.forEach(v=>{v.addEventListener("click",()=>{if(g)return;g=!0,String(v.dataset.id)===String(a.id)?(v.classList.add("correct"),setTimeout(()=>C(!0),800)):(v.classList.add("wrong"),p.forEach(A=>{String(A.dataset.id)===String(a.id)&&A.classList.add("correct")}),setTimeout(()=>C(!1),1500))})})}function $(h){h.innerHTML=`
    ...
    `,setTimeout(()=>document.getElementById("type-input").focus(),100);const i=document.getElementById("type-input"),m=document.getElementById("check-btn"),b=document.getElementById("give-up-btn");function p(){i.value.trim().toLowerCase()===a.word.toLowerCase()?(i.classList.add("correct"),m.innerHTML='<i class="fa-solid fa-check"></i> Correcto',D(a.word),setTimeout(()=>C(!0),1e3)):(i.classList.add("wrong"),D("Incorrect","en-US"),setTimeout(()=>i.classList.remove("wrong"),500))}m.addEventListener("click",p),i.addEventListener("keydown",g=>{g.key==="Enter"&&p()}),b.addEventListener("click",()=>{i.value=a.word,i.classList.add("wrong"),D(a.word),setTimeout(()=>C(!1),2e3)})}function B(h){const m=T().filter(k=>k.id!==a.id).sort(()=>.5-Math.random()).slice(0,3),b=[a,...m];R(b),h.innerHTML=`
      <div class="quiz-container">
         <div class="quiz-question">
    ...
    `;const p=document.getElementById("listen-icon"),g=()=>{p.style.transform="scale(0.9)",setTimeout(()=>p.style.transform="scale(1)",150),D(a.word)};p.addEventListener("click",g),setTimeout(g,500);const v=h.querySelectorAll(".quiz-option");let f=!1;v.forEach(k=>{k.addEventListener("click",()=>{if(f)return;f=!0,String(k.dataset.id)===String(a.id)?(k.classList.add("correct"),setTimeout(()=>C(!0),800)):(k.classList.add("wrong"),v.forEach(N=>{String(N.dataset.id)===String(a.id)&&N.classList.add("correct")}),setTimeout(()=>C(!1),1500))})})}function C(h){try{if(!a)return;if(De(a.id,h),h){s.correct++,s.xp+=10;try{de(1)}catch(i){console.error(i)}r.delete(a.id)}else{s.incorrect++;const i=r.get(a.id)||0;i<u&&(r.set(a.id,i+1),n.push(a))}a=null,E(),d()}catch(i){console.error("Error in handleResult:",i)}}function P(h){try{const i=s.incorrect===0&&s.correct>=5,m=de(0,{perfectSession:i}),b=document.querySelector(".review-header");b&&(b.style.display="none");let p;try{p=Q()}catch{p={streak:0,dailyGoal:{count:0,target:20}}}const g=te(),v=Ge(g),f=He(v);Xe(),h.innerHTML=`
          <div class="empty-review-state">
            ...
            <div class="streak-mini" style="margin: 1.5rem 0; padding: 1rem; background: #fffbeb; border-radius: 8px; border: 1px solid #fcd34d;">
                <p style="color: #b45309; font-weight: bold;"><i class="fa-solid fa-fire"></i> Racha: ${p.streak} días</p>
                <p style="font-size: 0.9rem; color: #92400e;">Meta diaria: ${p.dailyGoal.count} / ${p.dailyGoal.target}</p>
            </div>
    
            <button class="add-word-btn" id="finish-btn">Volver al inicio</button>
          </div>
        `,m.leveledUp&&setTimeout(()=>{Ue(m.newLevel)},500),f.length>0&&setTimeout(()=>{Ee(f)},m.leveledUp?5500:1e3),window.confetti||window.canvasConfetti?(window.confetti||window.canvasConfetti)({particleCount:100,spread:70,origin:{y:.6}}):la(()=>import("./confetti.module-C2jkTI5u.js"),[]).then(A=>{const M=A.default;M({particleCount:100,spread:70,origin:{y:.6}})}).catch(A=>console.log("Confetti not found",A));const k=document.getElementById("finish-btn");k&&k.addEventListener("click",()=>{t=null;const A=document.querySelector('[data-view="home"]');A?A.click():c()})}catch(i){console.error("Error in renderSummary:",i),h.innerHTML='<p class="error">Error al mostrar resumen. <button onclick="location.reload()">Recargar</button></p>'}}let V=null;function z(h){V&&V();const i=m=>{document.getElementById("active-content")&&document.activeElement.tagName!=="INPUT"&&h(m.code)};document.addEventListener("keydown",i),V=()=>document.removeEventListener("keydown",i),window._reviewCleanup=V}function R(h){for(let i=h.length-1;i>0;i--){const m=Math.floor(Math.random()*(i+1));[h[i],h[m]]=[h[m],h[i]]}return h}function J(h){return{word:"Palabra",phrasal:"Phrasal Verb",expression:"Expresión",connector:"Conector"}[h]||"Otro"}c()}function da(e){const t=T(),a=te();if(e.innerHTML="",e.className="stats-view animate__animated animate__fadeIn",a.total===0){pa(e);return}let o=0,n={master:0,guru:0,apprentice:0,new:0};t.forEach(l=>{const E=l.correctCount||0;E>=10?(o+=100,n.master++):E>=5?(o+=75,n.guru++):E>=2?(o+=40,n.apprentice++):(o+=10,n.new++)});const s=a.total>0?Math.round(o/a.total):0,r=ma(t),u=ua(t),c=ga(t),y=`
    <header class="dashboard-header" style="text-align: center;">
        ...
        <div class="global-grade">
            ...
            <span class="grade-value ${va(s)}">${ya(s)}</span>
        </div>
    </header>
        ...
        <div class="side-column">
                ...
                <div class="struggling-list">
                    ${c.length>0?c.map(l=>`
                        <div class="struggling-item">
                            <div class="s-info">
                                <span class="s-word">${l.word}</span>
                                <span class="s-meaning">${l.meaning}</span>
                            </div>
                            <div class="s-metric">
                                <span class="error-badge">${l.incorrectCount} fallos</span>
                            </div>
                        </div>
            ...
            <div class="dashboard-card achievements-card">
                <div class="card-header">
                    ...
                    <span class="achievements-counter">${Z().unlocked}/${Z().total}</span>
                </div>
                <div class="achievements-progress-bar">
                    <div class="fill" style="width: ${Z().percent}%"></div>
                </div>
                <div class="achievements-mini-grid">
                    ${_e().slice(0,8).map(l=>`
                        <div class="achievement-mini ${l.unlocked?"unlocked":"locked"}" title="${l.name}: ${l.description}">
  ...
  `;e.innerHTML=y}function pa(e){e.innerHTML=`
        <div class="empty-stats">
            <i class="fa-solid fa-chart-simple"></i>
            <h2>Sin datos suficientes</h2>
            <p>Añade algunas palabras para empezar a ver tus estadísticas.</p>
        </div>
    `}function ma(e){const t=[...e].sort((s,r)=>(s.createdAt||0)-(r.createdAt||0)),a=new Map;let o=0;t.forEach(s=>{o++;const r=new Date(s.createdAt||Date.now()).toISOString().split("T")[0];a.set(r,o)});const n=Array.from(a.entries()).map(([s,r])=>({date:s,count:r}));if(n.length>0&&n.length<2){const s=new Date(n[0].date);s.setDate(s.getDate()-1),n.unshift({date:s.toISOString().split("T")[0],count:0})}return n}function ua(e){const t=["word","phrasal","expression","connector"],a={};return t.forEach(o=>{const n=e.filter(l=>l.type===o),s=n.length;if(s===0)return;let r=0,u=0;n.forEach(l=>{r+=l.correctCount||0,u+=l.incorrectCount||0});const c=r+u,y=c===0?0:Math.round(r/c*100);a[o]={count:s,accuracy:y}}),a}function ga(e){return[...e].filter(t=>(t.incorrectCount||0)>0).sort((t,a)=>{const o=t.incorrectCount/(t.reviewCount||1);return a.incorrectCount/(a.reviewCount||1)-o}).slice(0,5)}function O(e,t){return t?Math.round(e/t*100):0}function ya(e){return e>=90?"S":e>=80?"A":e>=60?"B":e>=40?"C":"D"}function va(e){return e>=90?"text-legendary":e>=80?"text-success":e>=60?"text-primary":e>=40?"text-warning":"text-danger"}function fa(e){if(!e||e.length===0)return"";const t=800,a=300,o=20,n=e[e.length-1].count;if(n===0)return"";const s=e.map((y,l)=>{const E=l/(e.length-1)*(t-2*o)+o,w=a-(y.count/n*(a-2*o)+o);return`${E},${w}`}).join(" "),r=o,u=t-o,c=`${r},${a} ${s} ${u},${a}`;return`
        <svg viewBox="0 0 ${t} ${a}" class="svg-chart" preserveAspectRatio="none">
            ...
            <!-- Area Fill -->
            <polygon points="${c}" fill="url(#chartGradient)" />
            
            <!-- Line -->
            <polyline points="${s}" fill="none" stroke="var(--primary-400)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    `}function ha(e){if(!e||e.length<2)return"";const t=100,a=40,o=e[e.length-1].count,n=e.map((s,r)=>{const u=r/(e.length-1)*t,c=a-s.count/o*a;return`${u},${c}`}).join(" ");return`
    ...
    `}function wa(e){const t={word:"Palabras",phrasal:"Phrasal Verbs",expression:"Expresiones",connector:"Conectores"};return Object.entries(e).map(([a,o])=>`
    ...
    `).join("")}const q=document.getElementById("app");window.addEventListener("offline",()=>{L("Sin conexión","Estás trabajando en modo offline.","warning",5e3),document.body.classList.add("offline-mode")});window.addEventListener("online",()=>{L("Conexión restaurada","Tus cambios se guardarán correctamente.","success",3e3),document.body.classList.remove("offline-mode")});window.addEventListener("error",e=>{console.error("Global error:",e.error),L("Error inesperado","Ha ocurrido un error. Intenta recargar la página.","error",0)});window.addEventListener("unhandledrejection",e=>{console.error("Unhandled promise rejection:",e.reason)});const Se=document.querySelectorAll(".nav-link"),U=document.getElementById("theme-toggle"),ge=document.getElementById("audio-settings-btn");function ba(){const t=j().theme||"dark";se(t)}function se(e){document.documentElement.setAttribute("data-theme",e);const t=U.querySelector("i");e==="dark"?(t.className="fa-solid fa-sun",U.title="Cambiar a modo claro"):(t.className="fa-solid fa-moon",U.title="Cambiar a modo oscuro");const a=j();a.theme=e,we(a)}function xa(){const t=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.body.classList.add("theme-transitioning"),se(t),setTimeout(()=>{document.body.classList.remove("theme-transitioning")},300)}U.addEventListener("click",xa);window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",e=>{j().theme||se(e.matches?"dark":"light")});function Ie(){const e=document.getElementById("review-badge");if(!e)return;const t=Be();t>0?(e.textContent=t>99?"99+":t,e.style.display="flex"):e.style.display="none"}function ka(e){Se.forEach(t=>{t.dataset.view===e?t.classList.add("active"):t.classList.remove("active")})}function re(e){window._reviewCleanup&&(window._reviewCleanup(),window._reviewCleanup=null),ka(e),q.style.opacity="0",q.style.transform="translateY(10px)",setTimeout(()=>{switch(e){case"home":ee(q);break;case"add":sa(q);break;case"review":ca(q);break;case"stats":da(q);break;default:q.innerHTML="<p>Vista no encontrada</p>"}window.scrollTo({top:0,left:0,behavior:"instant"}),requestAnimationFrame(()=>{q.style.opacity="1",q.style.transform="translateY(0)"}),Ie()},150)}q.style.transition="opacity 0.15s ease, transform 0.15s ease";Se.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.view;re(a)})});const F=document.querySelector(".logo");F&&F.dataset.view&&F.addEventListener("click",e=>{e.preventDefault(),re(F.dataset.view)});ba();Ea();Ie();re("home");function Ea(){ge&&ge.addEventListener("click",Sa)}function Sa(){document.querySelector(".audio-settings-modal")?.remove();const e=ne(),t=document.createElement("div");t.className="audio-settings-modal edit-modal",t.innerHTML=`
    <div class="modal-overlay"></div>
