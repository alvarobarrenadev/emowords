export const starterPacks = [
...

  {
    ...
    words: [
      ...
      { word: 'Flexible', meaning: 'Flexible', type: 'word', category: 'Trabajo', example: 'We need to be flexible with deadlines.', emotionalTip: 'Adaptarte a los cambios sin romperte. La elasticidad profesional.' },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { word: 'Hang up', meaning: 'Colgar (teléfono)', type: 'phrasal', category: 'Phrasal Verbs', example: 'Don\'t hang up on me!', emotionalTip: 'Cortar una llamada en medio de una discusión. El silencio que sigue al click.' },
...

  {
    ...
    words: [
      ...
      { word: 'Hit it off', meaning: 'Conectar enseguida', type: 'phrasal', category: 'Relaciones', example: 'We hit it off immediately.', emotionalTip: 'Cuando la conexión con alguien es instantánea. Química natural.' },
...

  {
    ...
    words: [
      ...
      { word: 'Emphasize', meaning: 'Enfatizar / Recalcar', type: 'word', category: 'Opiniones', example: 'I want to emphasize this point.', emotionalTip: 'Subrayar lo importante para que no pase desapercibido. El énfasis que importa.' },
      ...
      { word: 'Exaggerate', meaning: 'Exagerar', type: 'word', category: 'Opiniones', example: 'Don\'t exaggerate, it wasn\'t that bad.', emotionalTip: 'Estirar la realidad más de la cuenta. Cuando la verdad no parece suficiente.' },
